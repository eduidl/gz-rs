...
//! Generated file from `gz/msgs/surface.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Surface)
pub struct Surface {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Surface.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Surface.friction)
    pub friction: ::protobuf::MessageField<super::friction::Friction>,
    // @@protoc_insertion_point(field:gz.msgs.Surface.restitution_coefficient)
    pub restitution_coefficient: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.bounce_threshold)
    pub bounce_threshold: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.soft_cfm)
    pub soft_cfm: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.soft_erp)
    pub soft_erp: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.kp)
    pub kp: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.kd)
    pub kd: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.max_vel)
    pub max_vel: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.min_depth)
    pub min_depth: f64,
    // @@protoc_insertion_point(field:gz.msgs.Surface.collide_without_contact)
    pub collide_without_contact: bool,
    // @@protoc_insertion_point(field:gz.msgs.Surface.collide_without_contact_bitmask)
    pub collide_without_contact_bitmask: u32,
    // @@protoc_insertion_point(field:gz.msgs.Surface.collide_bitmask)
    pub collide_bitmask: u32,
    // @@protoc_insertion_point(field:gz.msgs.Surface.elastic_modulus)
    pub elastic_modulus: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Surface.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15gz/msgs/surface.proto\x12\x07gz.msgs\x1a\x14gz/msgs/header.proto\
    \x1a\x16gz/msgs/friction.proto\"\xa2\x04\n\x07Surface\x12'\n\x06header\
    \x18\x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\x06header\x12-\n\x08friction\
    \x18\x02\x20\x01(\x0b2\x11.gz.msgs.FrictionR\x08friction\x127\n\x17resti\
    tution_coefficient\x18\x03\x20\x01(\x01R\x16restitutionCoefficient\x12)\
    \n\x10bounce_threshold\x18\x04\x20\x01(\x01R\x0fbounceThreshold\x12\x19\
    \n\x08soft_cfm\x18\x05\x20\x01(\x01R\x07softCfm\x12\x19\n\x08soft_erp\
    \x18\x06\x20\x01(\x01R\x07softErp\x12\x0e\n\x02kp\x18\x07\x20\x01(\x01R\
    \x02kp\x12\x0e\n\x02kd\x18\x08\x20\x01(\x01R\x02kd\x12\x17\n\x07max_vel\
    \x18\t\x20\x01(\x01R\x06maxVel\x12\x1b\n\tmin_depth\x18\n\x20\x01(\x01R\
    \x08minDepth\x126\n\x17collide_without_contact\x18\x0b\x20\x01(\x08R\x15\
    collideWithoutContact\x12E\n\x1fcollide_without_contact_bitmask\x18\x0c\
    \x20\x01(\rR\x1ccollideWithoutContactBitmask\x12'\n\x0fcollide_bitmask\
    \x18\r\x20\x01(\rR\x0ecollideBitmask\x12'\n\x0felastic_modulus\x18\x0e\
    \x20\x01(\x01R\x0eelasticModulusB\x1c\n\x0bcom.gz.msgsB\rSurfaceProtosb\
    \x06proto3\
";
