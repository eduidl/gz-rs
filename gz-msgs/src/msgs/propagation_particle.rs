...
//! Generated file from `gz/msgs/propagation_particle.proto`
...
// @@protoc_insertion_point(message:gz.msgs.PropagationParticle)
pub struct PropagationParticle {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.PropagationParticle.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.PropagationParticle.x)
    pub x: f64,
    // @@protoc_insertion_point(field:gz.msgs.PropagationParticle.y)
    pub y: f64,
    // @@protoc_insertion_point(field:gz.msgs.PropagationParticle.signal_level)
    pub signal_level: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.PropagationParticle.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"gz/msgs/propagation_particle.proto\x12\x07gz.msgs\x1a\x14gz/msgs/hea\
    der.proto\"}\n\x13PropagationParticle\x12'\n\x06header\x18\x01\x20\x01(\
    \x0b2\x0f.gz.msgs.HeaderR\x06header\x12\x0c\n\x01x\x18\x02\x20\x01(\x01R\
    \x01x\x12\x0c\n\x01y\x18\x03\x20\x01(\x01R\x01y\x12!\n\x0csignal_level\
    \x18\x04\x20\x01(\x01R\x0bsignalLevelB(\n\x0bcom.gz.msgsB\x19Propagation\
    ParticleProtosb\x06proto3\
";
