...
//! Generated file from `gz/msgs/header.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Header)
pub struct Header {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Header.stamp)
    pub stamp: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:gz.msgs.Header.data)
    pub data: ::std::vec::Vec<header::Map>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Header.special_fields)
...
pub mod header {
    #[derive(PartialEq,Clone,Default,Debug)]
    // @@protoc_insertion_point(message:gz.msgs.Header.Map)
    pub struct Map {
        // message fields
        // @@protoc_insertion_point(field:gz.msgs.Header.Map.key)
        pub key: ::std::string::String,
        // @@protoc_insertion_point(field:gz.msgs.Header.Map.value)
        pub value: ::std::vec::Vec<::std::string::String>,
        // special fields
        // @@protoc_insertion_point(special_field:gz.msgs.Header.Map.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14gz/msgs/header.proto\x12\x07gz.msgs\x1a\x12gz/msgs/time.proto\"\
    \x85\x01\n\x06Header\x12#\n\x05stamp\x18\x01\x20\x01(\x0b2\r.gz.msgs.Tim\
    eR\x05stamp\x12'\n\x04data\x18\x02\x20\x03(\x0b2\x13.gz.msgs.Header.MapR\
    \x04data\x1a-\n\x03Map\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\
    \x14\n\x05value\x18\x02\x20\x03(\tR\x05valueB\x1b\n\x0bcom.gz.msgsB\x0cH\
    eaderProtosb\x06proto3\
";
