...
//! Generated file from `gz/msgs/scene.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Scene)
pub struct Scene {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Scene.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Scene.ambient)
    pub ambient: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.background)
    pub background: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.sky)
    pub sky: ::protobuf::MessageField<super::sky::Sky>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.shadows)
    pub shadows: bool,
    // @@protoc_insertion_point(field:gz.msgs.Scene.fog)
    pub fog: ::protobuf::MessageField<super::fog::Fog>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.grid)
    pub grid: bool,
    // @@protoc_insertion_point(field:gz.msgs.Scene.model)
    pub model: ::std::vec::Vec<super::model::Model>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.light)
    pub light: ::std::vec::Vec<super::light::Light>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.joint)
    pub joint: ::std::vec::Vec<super::joint::Joint>,
    // @@protoc_insertion_point(field:gz.msgs.Scene.origin_visual)
    pub origin_visual: bool,
    // @@protoc_insertion_point(field:gz.msgs.Scene.shadow_caster_material_script)
    pub shadow_caster_material_script: ::protobuf::MessageField<super::material::material::Script>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Scene.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x13gz/msgs/scene.proto\x12\x07gz.msgs\x1a\x13gz/msgs/color.proto\x1a\
    \x11gz/msgs/fog.proto\x1a\x11gz/msgs/sky.proto\x1a\x13gz/msgs/light.prot\
    o\x1a\x13gz/msgs/joint.proto\x1a\x16gz/msgs/material.proto\x1a\x13gz/msg\
    s/model.proto\x1a\x14gz/msgs/header.proto\"\x80\x04\n\x05Scene\x12'\n\
    \x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\x06header\x12\x12\n\
    \x04name\x18\x02\x20\x01(\tR\x04name\x12(\n\x07ambient\x18\x03\x20\x01(\
    \x0b2\x0e.gz.msgs.ColorR\x07ambient\x12.\n\nbackground\x18\x04\x20\x01(\
    \x0b2\x0e.gz.msgs.ColorR\nbackground\x12\x1e\n\x03sky\x18\x05\x20\x01(\
    \x0b2\x0c.gz.msgs.SkyR\x03sky\x12\x18\n\x07shadows\x18\x06\x20\x01(\x08R\
    \x07shadows\x12\x1e\n\x03fog\x18\x07\x20\x01(\x0b2\x0c.gz.msgs.FogR\x03f\
    og\x12\x12\n\x04grid\x18\x08\x20\x01(\x08R\x04grid\x12$\n\x05model\x18\t\
    \x20\x03(\x0b2\x0e.gz.msgs.ModelR\x05model\x12$\n\x05light\x18\n\x20\x03\
    (\x0b2\x0e.gz.msgs.LightR\x05light\x12$\n\x05joint\x18\x0b\x20\x03(\x0b2\
    \x0e.gz.msgs.JointR\x05joint\x12#\n\rorigin_visual\x18\x0c\x20\x01(\x08R\
    \x0coriginVisual\x12[\n\x1dshadow_caster_material_script\x18\r\x20\x01(\
    \x0b2\x18.gz.msgs.Material.ScriptR\x1ashadowCasterMaterialScriptB\x1a\n\
    \x0bcom.gz.msgsB\x0bSceneProtosb\x06proto3\
";
