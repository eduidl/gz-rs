...
//! Generated file from `gz/msgs/pose_trajectory.proto`
...
// @@protoc_insertion_point(message:gz.msgs.PoseTrajectory)
pub struct PoseTrajectory {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.PoseTrajectory.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.PoseTrajectory.id)
    pub id: u32,
    // @@protoc_insertion_point(field:gz.msgs.PoseTrajectory.pose)
    pub pose: ::std::vec::Vec<super::pose::Pose>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.PoseTrajectory.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dgz/msgs/pose_trajectory.proto\x12\x07gz.msgs\x1a\x12gz/msgs/pose.p\
    roto\"W\n\x0ePoseTrajectory\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04nam\
    e\x12\x0e\n\x02id\x18\x02\x20\x01(\rR\x02id\x12!\n\x04pose\x18\x03\x20\
    \x03(\x0b2\r.gz.msgs.PoseR\x04poseB#\n\x0bcom.gz.msgsB\x14PoseTrajectory\
    Protosb\x06proto3\
";
