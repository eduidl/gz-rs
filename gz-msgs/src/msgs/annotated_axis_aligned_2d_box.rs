...
//! Generated file from `gz/msgs/annotated_axis_aligned_2d_box.proto`
...
// @@protoc_insertion_point(message:gz.msgs.AnnotatedAxisAligned2DBox)
pub struct AnnotatedAxisAligned2DBox {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.AnnotatedAxisAligned2DBox.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.AnnotatedAxisAligned2DBox.box)
    pub box_: ::protobuf::MessageField<super::axis_aligned_2d_box::AxisAligned2DBox>,
    // @@protoc_insertion_point(field:gz.msgs.AnnotatedAxisAligned2DBox.label)
    pub label: u32,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.AnnotatedAxisAligned2DBox.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n+gz/msgs/annotated_axis_aligned_2d_box.proto\x12\x07gz.msgs\x1a\x14gz/\
    msgs/header.proto\x1a!gz/msgs/axis_aligned_2d_box.proto\"\x87\x01\n\x19A\
    nnotatedAxisAligned2DBox\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.m\
    sgs.HeaderR\x06header\x12+\n\x03box\x18\x02\x20\x01(\x0b2\x19.gz.msgs.Ax\
    isAligned2DBoxR\x03box\x12\x14\n\x05label\x18\x03\x20\x01(\rR\x05labelB.\
    \n\x0bcom.gz.msgsB\x1fAnnotatedAxisAligned2DBoxProtosb\x06proto3\
";
