...
//! Generated file from `gz/msgs/vector3d.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Vector3d)
pub struct Vector3d {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Vector3d.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Vector3d.x)
    pub x: f64,
    // @@protoc_insertion_point(field:gz.msgs.Vector3d.y)
    pub y: f64,
    // @@protoc_insertion_point(field:gz.msgs.Vector3d.z)
    pub z: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Vector3d.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16gz/msgs/vector3d.proto\x12\x07gz.msgs\x1a\x14gz/msgs/header.proto\
    \"]\n\x08Vector3d\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.Hea\
    derR\x06header\x12\x0c\n\x01x\x18\x02\x20\x01(\x01R\x01x\x12\x0c\n\x01y\
    \x18\x03\x20\x01(\x01R\x01y\x12\x0c\n\x01z\x18\x04\x20\x01(\x01R\x01zB\
    \x1d\n\x0bcom.gz.msgsB\x0eVector3dProtosb\x06proto3\
";
