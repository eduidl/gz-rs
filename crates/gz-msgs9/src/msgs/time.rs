...
//! Generated file from `gz/msgs/time.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Time)
pub struct Time {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Time.sec)
    pub sec: i64,
    // @@protoc_insertion_point(field:gz.msgs.Time.nsec)
    pub nsec: i32,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Time.special_fields)
