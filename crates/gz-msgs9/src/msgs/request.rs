...
//! Generated file from `gz/msgs/request.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Request)
pub struct Request {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Request.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Request.id)
    pub id: i32,
    // @@protoc_insertion_point(field:gz.msgs.Request.request)
    pub request: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Request.data)
    pub data: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Request.dbl_data)
    pub dbl_data: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Request.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15gz/msgs/request.proto\x12\x07gz.msgs\x1a\x14gz/msgs/header.proto\"\
    \x8b\x01\n\x07Request\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs\
    .HeaderR\x06header\x12\x0e\n\x02id\x18\x02\x20\x01(\x05R\x02id\x12\x18\n\
    \x07request\x18\x03\x20\x01(\tR\x07request\x12\x12\n\x04data\x18\x04\x20\
    \x01(\tR\x04data\x12\x19\n\x08dbl_data\x18\x05\x20\x01(\x01R\x07dblDataB\
    \x1c\n\x0bcom.gz.msgsB\rRequestProtosb\x06proto3\
";
