...
//! Generated file from `gz/msgs/logical_camera_sensor.proto`
...
// @@protoc_insertion_point(message:gz.msgs.LogicalCameraSensor)
pub struct LogicalCameraSensor {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.LogicalCameraSensor.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.LogicalCameraSensor.near_clip)
    pub near_clip: f64,
    // @@protoc_insertion_point(field:gz.msgs.LogicalCameraSensor.far_clip)
    pub far_clip: f64,
    // @@protoc_insertion_point(field:gz.msgs.LogicalCameraSensor.horizontal_fov)
    pub horizontal_fov: f64,
    // @@protoc_insertion_point(field:gz.msgs.LogicalCameraSensor.aspect_ratio)
    pub aspect_ratio: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.LogicalCameraSensor.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#gz/msgs/logical_camera_sensor.proto\x12\x07gz.msgs\x1a\x14gz/msgs/hea\
    der.proto\"\xc0\x01\n\x13LogicalCameraSensor\x12'\n\x06header\x18\x01\
    \x20\x01(\x0b2\x0f.gz.msgs.HeaderR\x06header\x12\x1b\n\tnear_clip\x18\
    \x02\x20\x01(\x01R\x08nearClip\x12\x19\n\x08far_clip\x18\x03\x20\x01(\
    \x01R\x07farClip\x12%\n\x0ehorizontal_fov\x18\x04\x20\x01(\x01R\rhorizon\
    talFov\x12!\n\x0caspect_ratio\x18\x05\x20\x01(\x01R\x0baspectRatioB(\n\
    \x0bcom.gz.msgsB\x19LogicalCameraSensorProtosb\x06proto3\
";
