...
//! Generated file from `gz/msgs/rest_logout.proto`
...
// @@protoc_insertion_point(message:gz.msgs.RestLogout)
pub struct RestLogout {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.RestLogout.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.RestLogout.id)
    pub id: u32,
    // @@protoc_insertion_point(field:gz.msgs.RestLogout.url)
    pub url: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.RestLogout.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19gz/msgs/rest_logout.proto\x12\x07gz.msgs\x1a\x14gz/msgs/header.pro\
    to\"W\n\nRestLogout\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.H\
    eaderR\x06header\x12\x0e\n\x02id\x18\x02\x20\x01(\rR\x02id\x12\x10\n\x03\
    url\x18\x03\x20\x01(\tR\x03urlB\x1f\n\x0bcom.gz.msgsB\x10RestLogoutProto\
    sb\x06proto3\
";
