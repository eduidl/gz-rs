...
//! Generated file from `gz/msgs/altimeter.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Altimeter)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Altimeter {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Altimeter.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Altimeter.vertical_position)
    pub vertical_position: f64,
    // @@protoc_insertion_point(field:gz.msgs.Altimeter.vertical_velocity)
    pub vertical_velocity: f64,
    // @@protoc_insertion_point(field:gz.msgs.Altimeter.vertical_reference)
    pub vertical_reference: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Altimeter.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gs.HeaderR\x06header\x12+\n\x11vertical_position\x18\x02\x20\x01(\x01R\
    \x10verticalPosition\x12+\n\x11vertical_velocity\x18\x03\x20\x01(\x01R\
    \x10verticalVelocity\x12-\n\x12vertical_reference\x18\x04\x20\x01(\x01R\
    \x11verticalReferenceB\x1e\n\x0bcom.gz.msgsB\x0fAltimeterProtosb\x06prot\
    o3\
";
