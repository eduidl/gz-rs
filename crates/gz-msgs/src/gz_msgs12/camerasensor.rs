...
pub mod camera_sensor {
    ...
    impl ::protobuf::Enum for BoundingBoxType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<BoundingBoxType> {
            match str {
                "NO_BOUNDING_BOX" => ::std::option::Option::Some(BoundingBoxType::NO_BOUNDING_BOX),
                "FULL_BOX_2D" => ::std::option::Option::Some(BoundingBoxType::FULL_BOX_2D),
                "VISIBLE_BOX_2D" => ::std::option::Option::Some(BoundingBoxType::VISIBLE_BOX_2D),
                "BOX_3D" => ::std::option::Option::Some(BoundingBoxType::BOX_3D),
                _ => ::std::option::Option::None
            }
        }
    ...
    impl ::protobuf::Enum for SegmentationType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<SegmentationType> {
            match str {
                "NO_SEGMENTATION" => ::std::option::Option::Some(SegmentationType::NO_SEGMENTATION),
                "SEMANTIC" => ::std::option::Option::Some(SegmentationType::SEMANTIC),
                "PANOPTIC" => ::std::option::Option::Some(SegmentationType::PANOPTIC),
                _ => ::std::option::Option::None
            }
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .proto\x1a\x16gz/msgs/vector2d.proto\"\xee\x08\n\x0cCameraSensor\x12'\n\
    ...
    e_format\x18\x04\x20\x01(\tR\x0bimageFormatB\x02\x18\x01\x12\x1b\n\tnear\
    _clip\x18\x05\x20\x01(\x01R\x08nearClip\x12\x19\n\x08far_clip\x18\x06\
    \x20\x01(\x01R\x07farClip\x12!\n\x0csave_enabled\x18\x07\x20\x01(\x08R\
    \x0bsaveEnabled\x12\x1b\n\tsave_path\x18\x08\x20\x01(\tR\x08savePath\x12\
    3\n\ndistortion\x18\t\x20\x01(\x0b2\x13.gz.msgs.DistortionR\ndistortion\
    \x125\n\x0bimage_noise\x18\n\x20\x01(\x0b2\x14.gz.msgs.SensorNoiseR\nima\
    geNoise\x127\n\x0fdepth_near_clip\x18\x0b\x20\x01(\x0b2\x0f.gz.msgs.Doub\
    leR\rdepthNearClip\x125\n\x0edepth_far_clip\x18\x0c\x20\x01(\x0b2\x0f.gz\
    .msgs.DoubleR\x0cdepthFarClip\x12Q\n\x11bounding_box_type\x18\r\x20\x01(\
    \x0e2%.gz.msgs.CameraSensor.BoundingBoxTypeR\x0fboundingBoxType\x12S\n\
    \x11segmentation_type\x18\x0e\x20\x01(\x0e2&.gz.msgs.CameraSensor.Segmen\
    tationTypeR\x10segmentationType\x12!\n\x04lens\x18\x0f\x20\x01(\x0b2\r.g\
    z.msgs.LensR\x04lens\x12\x1c\n\ttriggered\x18\x10\x20\x01(\x08R\ttrigger\
    ed\x12'\n\x0ftriggered_topic\x18\x11\x20\x01(\tR\x0etriggeredTopic\x12#\
    \n\ranti_aliasing\x18\x12\x20\x01(\x05R\x0cantiAliasing\x12'\n\x0fvisibi\
    lity_mask\x18\x13\x20\x01(\rR\x0evisibilityMask\x12&\n\x0fis_depth_camer\
    a\x18\x14\x20\x01(\x08R\risDepthCamera\x12;\n\x0cpixel_format\x18\x15\
    \x20\x01(\x0e2\x18.gz.msgs.PixelFormatTypeR\x0bpixelFormat\"W\n\x0fBound\
    ingBoxType\x12\x13\n\x0fNO_BOUNDING_BOX\x10\0\x12\x0f\n\x0bFULL_BOX_2D\
    \x10\x01\x12\x12\n\x0eVISIBLE_BOX_2D\x10\x02\x12\n\n\x06BOX_3D\x10\x03\"\
    C\n\x10SegmentationType\x12\x13\n\x0fNO_SEGMENTATION\x10\0\x12\x0c\n\x08\
    SEMANTIC\x10\x01\x12\x0c\n\x08PANOPTIC\x10\x02B!\n\x0bcom.gz.msgsB\x12Ca\
    meraSensorProtosb\x06proto3\
";
