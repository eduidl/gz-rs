...
pub struct Sensor {
    ...
    // @@protoc_insertion_point(field:gz.msgs.Sensor.air_speed)
    pub air_speed: ::protobuf::MessageField<super::air_speed_sensor::AirSpeedSensor>,
    // @@protoc_insertion_point(field:gz.msgs.Sensor.navsat)
    pub navsat: ::protobuf::MessageField<super::navsat_sensor::NavSatSensor>,
    // special fields
...
impl Sensor {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::air_speed_sensor::AirSpeedSensor>(
            "air_speed",
            |m: &Sensor| { &m.air_speed },
            |m: &mut Sensor| { &mut m.air_speed },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::navsat_sensor::NavSatSensor>(
            "navsat",
            |m: &Sensor| { &m.navsat },
            |m: &mut Sensor| { &mut m.navsat },
        ));
...
impl ::protobuf::Message for Sensor {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                170 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.air_speed)?;
                },
                178 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.navsat)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.air_speed.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        if let Some(v) = self.navsat.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
    ...
    fn default_instance() -> &'static Sensor {
        static instance: Sensor = Sensor {
            ...
            air_speed: ::protobuf::MessageField::none(),
            navsat: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    r.proto\x1a\x1egz/msgs/air_speed_sensor.proto\x1a\x1agz/msgs/camerasenso\
    r.proto\x1a\x1bgz/msgs/contactsensor.proto\x1a!gz/msgs/air_pressure_sens\
    or.proto\x1a\x18gz/msgs/gps_sensor.proto\x1a\x14gz/msgs/header.proto\x1a\
    \x18gz/msgs/imu_sensor.proto\x1a\x1agz/msgs/lidar_sensor.proto\x1a#gz/ms\
    gs/logical_camera_sensor.proto\x1a!gz/msgs/magnetometer_sensor.proto\x1a\
    \x1bgz/msgs/navsat_sensor.proto\x1a\x12gz/msgs/pose.proto\"\xf2\x06\n\
    ...
    \n\x07contact\x18\x0b\x20\x01(\x0b2\x16.gz.msgs.ContactSensorR\x07contac\
    t\x12\x1c\n\tvisualize\x18\x0c\x20\x01(\x08R\tvisualize\x12\x14\n\x05top\
    ic\x18\r\x20\x01(\tR\x05topic\x12C\n\x0elogical_camera\x18\x0e\x20\x01(\
    \x0b2\x1c.gz.msgs.LogicalCameraSensorR\rlogicalCamera\x12(\n\x03gps\x18\
    \x0f\x20\x01(\x0b2\x12.gz.msgs.GPSSensorR\x03gpsB\x02\x18\x01\x12$\n\x03\
    imu\x18\x10\x20\x01(\x0b2\x12.gz.msgs.IMUSensorR\x03imu\x12?\n\x0cmagnet\
    ometer\x18\x11\x20\x01(\x0b2\x1b.gz.msgs.MagnetometerSensorR\x0cmagnetom\
    eter\x126\n\taltimeter\x18\x12\x20\x01(\x0b2\x18.gz.msgs.AltimeterSensor\
    R\taltimeter\x12=\n\x0cair_pressure\x18\x13\x20\x01(\x0b2\x1a.gz.msgs.Ai\
    rPressureSensorR\x0bairPressure\x12*\n\x05lidar\x18\x14\x20\x01(\x0b2\
    \x14.gz.msgs.LidarSensorR\x05lidar\x124\n\tair_speed\x18\x15\x20\x01(\
    \x0b2\x17.gz.msgs.AirSpeedSensorR\x08airSpeed\x12-\n\x06navsat\x18\x16\
    \x20\x01(\x0b2\x15.gz.msgs.NavSatSensorR\x06navsatB\x1b\n\x0bcom.gz.msgs\
    B\x0cSensorProtosb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::air_speed_sensor::file_descriptor().clone());
            ...
            deps.push(super::navsat_sensor::file_descriptor().clone());
