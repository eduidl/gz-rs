...
//! Generated file from `gz/msgs/geometry.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Geometry)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Geometry {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Geometry.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.type)
    pub type_: ::protobuf::EnumOrUnknown<geometry::Type>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.box)
    pub box_: ::protobuf::MessageField<super::boxgeom::BoxGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.cylinder)
    pub cylinder: ::protobuf::MessageField<super::cylindergeom::CylinderGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.plane)
    pub plane: ::protobuf::MessageField<super::planegeom::PlaneGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.sphere)
    pub sphere: ::protobuf::MessageField<super::spheregeom::SphereGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.image)
    pub image: ::protobuf::MessageField<super::imagegeom::ImageGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.heightmap)
    pub heightmap: ::protobuf::MessageField<super::heightmapgeom::HeightmapGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.mesh)
    pub mesh: ::protobuf::MessageField<super::meshgeom::MeshGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.cone)
    pub cone: ::protobuf::MessageField<super::conegeom::ConeGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.capsule)
    pub capsule: ::protobuf::MessageField<super::capsulegeom::CapsuleGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.ellipsoid)
    pub ellipsoid: ::protobuf::MessageField<super::ellipsoidgeom::EllipsoidGeom>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.points)
    pub points: ::std::vec::Vec<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:gz.msgs.Geometry.polyline)
    pub polyline: ::std::vec::Vec<super::polylinegeom::Polyline>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Geometry.special_fields)
...
pub mod geometry {
    ...
    // @@protoc_insertion_point(enum:gz.msgs.Geometry.Type)
    pub enum Type {
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.BOX)
        BOX = 0,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.CYLINDER)
        CYLINDER = 1,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.SPHERE)
        SPHERE = 2,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.PLANE)
        PLANE = 3,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.IMAGE)
        IMAGE = 4,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.HEIGHTMAP)
        HEIGHTMAP = 5,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.MESH)
        MESH = 6,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.TRIANGLE_FAN)
        TRIANGLE_FAN = 7,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.LINE_STRIP)
        LINE_STRIP = 8,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.POLYLINE)
        POLYLINE = 9,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.CONE)
        CONE = 10,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.EMPTY)
        EMPTY = 11,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.ARROW)
        ARROW = 12,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.AXIS)
        AXIS = 13,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.CAPSULE)
        CAPSULE = 14,
        // @@protoc_insertion_point(enum_value:gz.msgs.Geometry.Type.ELLIPSOID)
        ELLIPSOID = 15,
    }
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "BOX" => ::std::option::Option::Some(Type::BOX),
                "CYLINDER" => ::std::option::Option::Some(Type::CYLINDER),
                "SPHERE" => ::std::option::Option::Some(Type::SPHERE),
                "PLANE" => ::std::option::Option::Some(Type::PLANE),
                "IMAGE" => ::std::option::Option::Some(Type::IMAGE),
                "HEIGHTMAP" => ::std::option::Option::Some(Type::HEIGHTMAP),
                "MESH" => ::std::option::Option::Some(Type::MESH),
                "TRIANGLE_FAN" => ::std::option::Option::Some(Type::TRIANGLE_FAN),
                "LINE_STRIP" => ::std::option::Option::Some(Type::LINE_STRIP),
                "POLYLINE" => ::std::option::Option::Some(Type::POLYLINE),
                "CONE" => ::std::option::Option::Some(Type::CONE),
                "EMPTY" => ::std::option::Option::Some(Type::EMPTY),
                "ARROW" => ::std::option::Option::Some(Type::ARROW),
                "AXIS" => ::std::option::Option::Some(Type::AXIS),
                "CAPSULE" => ::std::option::Option::Some(Type::CAPSULE),
                "ELLIPSOID" => ::std::option::Option::Some(Type::ELLIPSOID),
                _ => ::std::option::Option::None
            }
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16gz/msgs/geometry.proto\x12\x07gz.msgs\x1a\x15gz/msgs/boxgeom.proto\
    \x1a\x19gz/msgs/capsulegeom.proto\x1a\x16gz/msgs/conegeom.proto\x1a\x1ag\
    z/msgs/cylindergeom.proto\x1a\x1bgz/msgs/ellipsoidgeom.proto\x1a\x14gz/m\
    sgs/header.proto\x1a\x1bgz/msgs/heightmapgeom.proto\x1a\x17gz/msgs/image\
    geom.proto\x1a\x16gz/msgs/meshgeom.proto\x1a\x17gz/msgs/planegeom.proto\
    \x1a\x1agz/msgs/polylinegeom.proto\x1a\x18gz/msgs/spheregeom.proto\x1a\
    \x16gz/msgs/vector3d.proto\"\xcc\x06\n\x08Geometry\x12'\n\x06header\x18\
    \x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\x06header\x12*\n\x04type\x18\x02\
    \x20\x01(\x0e2\x16.gz.msgs.Geometry.TypeR\x04type\x12\"\n\x03box\x18\x03\
    \x20\x01(\x0b2\x10.gz.msgs.BoxGeomR\x03box\x121\n\x08cylinder\x18\x04\
    \x20\x01(\x0b2\x15.gz.msgs.CylinderGeomR\x08cylinder\x12(\n\x05plane\x18\
    \x05\x20\x01(\x0b2\x12.gz.msgs.PlaneGeomR\x05plane\x12+\n\x06sphere\x18\
    \x06\x20\x01(\x0b2\x13.gz.msgs.SphereGeomR\x06sphere\x12(\n\x05image\x18\
    \x07\x20\x01(\x0b2\x12.gz.msgs.ImageGeomR\x05image\x124\n\theightmap\x18\
    \x08\x20\x01(\x0b2\x16.gz.msgs.HeightmapGeomR\theightmap\x12%\n\x04mesh\
    \x18\t\x20\x01(\x0b2\x11.gz.msgs.MeshGeomR\x04mesh\x12%\n\x04cone\x18\n\
    \x20\x01(\x0b2\x11.gz.msgs.ConeGeomR\x04cone\x12.\n\x07capsule\x18\r\x20\
    \x01(\x0b2\x14.gz.msgs.CapsuleGeomR\x07capsule\x124\n\tellipsoid\x18\x0e\
    \x20\x01(\x0b2\x16.gz.msgs.EllipsoidGeomR\tellipsoid\x12)\n\x06points\
    \x18\x0b\x20\x03(\x0b2\x11.gz.msgs.Vector3dR\x06points\x12-\n\x08polylin\
    e\x18\x0c\x20\x03(\x0b2\x11.gz.msgs.PolylineR\x08polyline\"\xce\x01\n\
    ...
    \x12\x08\n\x04CONE\x10\n\x12\t\n\x05EMPTY\x10\x0b\x12\t\n\x05ARROW\x10\
    \x0c\x12\x08\n\x04AXIS\x10\r\x12\x0b\n\x07CAPSULE\x10\x0e\x12\r\n\tELLIP\
    SOID\x10\x0fB\x1d\n\x0bcom.gz.msgsB\x0eGeometryProtosb\x06proto3\
";
