...
//! Generated file from `gz/msgs/imu_sensor.proto`
...
// @@protoc_insertion_point(message:gz.msgs.IMUSensor)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct IMUSensor {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.IMUSensor.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.IMUSensor.angular_velocity)
    pub angular_velocity: ::protobuf::MessageField<imusensor::AngularVelocity>,
    // @@protoc_insertion_point(field:gz.msgs.IMUSensor.linear_acceleration)
    pub linear_acceleration: ::protobuf::MessageField<imusensor::LinearAcceleration>,
    // @@protoc_insertion_point(field:gz.msgs.IMUSensor.orientation_ref_frame)
    pub orientation_ref_frame: ::protobuf::MessageField<imusensor::OrientationReferenceFrame>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.IMUSensor.special_fields)
...
pub mod imusensor {
    #[derive(::gz_msgs_common::GzMessage)]
    // @@protoc_insertion_point(message:gz.msgs.IMUSensor.AngularVelocity)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct AngularVelocity {
        // message fields
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.AngularVelocity.x_noise)
        pub x_noise: ::protobuf::MessageField<super::super::sensor_noise::SensorNoise>,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.AngularVelocity.y_noise)
        pub y_noise: ::protobuf::MessageField<super::super::sensor_noise::SensorNoise>,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.AngularVelocity.z_noise)
        pub z_noise: ::protobuf::MessageField<super::super::sensor_noise::SensorNoise>,
        // special fields
        // @@protoc_insertion_point(special_field:gz.msgs.IMUSensor.AngularVelocity.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    #[derive(::gz_msgs_common::GzMessage)]
    // @@protoc_insertion_point(message:gz.msgs.IMUSensor.LinearAcceleration)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct LinearAcceleration {
        // message fields
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.LinearAcceleration.x_noise)
        pub x_noise: ::protobuf::MessageField<super::super::sensor_noise::SensorNoise>,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.LinearAcceleration.y_noise)
        pub y_noise: ::protobuf::MessageField<super::super::sensor_noise::SensorNoise>,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.LinearAcceleration.z_noise)
        pub z_noise: ::protobuf::MessageField<super::super::sensor_noise::SensorNoise>,
        // special fields
        // @@protoc_insertion_point(special_field:gz.msgs.IMUSensor.LinearAcceleration.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    #[derive(::gz_msgs_common::GzMessage)]
    // @@protoc_insertion_point(message:gz.msgs.IMUSensor.OrientationReferenceFrame)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct OrientationReferenceFrame {
        // message fields
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.OrientationReferenceFrame.localization)
        pub localization: ::std::string::String,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.OrientationReferenceFrame.custom_rpy)
        pub custom_rpy: ::protobuf::MessageField<super::super::vector3d::Vector3d>,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.OrientationReferenceFrame.custom_rpy_parent_frame)
        pub custom_rpy_parent_frame: ::std::string::String,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.OrientationReferenceFrame.gravity_dir_x)
        pub gravity_dir_x: ::protobuf::MessageField<super::super::vector3d::Vector3d>,
        // @@protoc_insertion_point(field:gz.msgs.IMUSensor.OrientationReferenceFrame.gravity_dir_x_parent_frame)
        pub gravity_dir_x_parent_frame: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:gz.msgs.IMUSensor.OrientationReferenceFrame.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18gz/msgs/imu_sensor.proto\x12\x07gz.msgs\x1a\x1agz/msgs/sensor_nois\
    e.proto\x1a\x14gz/msgs/header.proto\x1a\x16gz/msgs/vector3d.proto\"\xa0\
    \x07\n\tIMUSensor\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.Hea\
    derR\x06header\x12M\n\x10angular_velocity\x18\x02\x20\x01(\x0b2\".gz.msg\
    s.IMUSensor.AngularVelocityR\x0fangularVelocity\x12V\n\x13linear_acceler\
    ation\x18\x03\x20\x01(\x0b2%.gz.msgs.IMUSensor.LinearAccelerationR\x12li\
    nearAcceleration\x12`\n\x15orientation_ref_frame\x18\x04\x20\x01(\x0b2,.\
    gz.msgs.IMUSensor.OrientationReferenceFrameR\x13orientationRefFrame\x1a\
    \x9e\x01\n\x0fAngularVelocity\x12-\n\x07x_noise\x18\x01\x20\x01(\x0b2\
    \x14.gz.msgs.SensorNoiseR\x06xNoise\x12-\n\x07y_noise\x18\x02\x20\x01(\
    \x0b2\x14.gz.msgs.SensorNoiseR\x06yNoise\x12-\n\x07z_noise\x18\x03\x20\
    \x01(\x0b2\x14.gz.msgs.SensorNoiseR\x06zNoise\x1a\xa1\x01\n\x12LinearAcc\
    eleration\x12-\n\x07x_noise\x18\x01\x20\x01(\x0b2\x14.gz.msgs.SensorNois\
    eR\x06xNoise\x12-\n\x07y_noise\x18\x02\x20\x01(\x0b2\x14.gz.msgs.SensorN\
    oiseR\x06yNoise\x12-\n\x07z_noise\x18\x03\x20\x01(\x0b2\x14.gz.msgs.Sens\
    orNoiseR\x06zNoise\x1a\x9b\x02\n\x19OrientationReferenceFrame\x12\"\n\
    \x0clocalization\x18\x01\x20\x01(\tR\x0clocalization\x120\n\ncustom_rpy\
    \x18\x02\x20\x01(\x0b2\x11.gz.msgs.Vector3dR\tcustomRpy\x125\n\x17custom\
    _rpy_parent_frame\x18\x03\x20\x01(\tR\x14customRpyParentFrame\x125\n\rgr\
    avity_dir_x\x18\x04\x20\x01(\x0b2\x11.gz.msgs.Vector3dR\x0bgravityDirX\
    \x12:\n\x1agravity_dir_x_parent_frame\x18\x05\x20\x01(\tR\x16gravityDirX\
    ParentFrameB\x1e\n\x0bcom.gz.msgsB\x0fIMUSensorProtosb\x06proto3\
";
