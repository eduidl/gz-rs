...
//! Generated file from `gz/msgs/double.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Double)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Double {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Double.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Double.data)
    pub data: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Double.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14gz/msgs/double.proto\x12\x07gz.msgs\x1a\x14gz/msgs/header.proto\"E\
    \n\x06Double\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\
    \x06header\x12\x12\n\x04data\x18\x02\x20\x01(\x01R\x04dataB\x1b\n\x0bcom\
    .gz.msgsB\x0cDoubleProtosb\x06proto3\
";
