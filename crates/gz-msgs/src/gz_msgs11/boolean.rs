...
//! Generated file from `gz/msgs/boolean.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Boolean)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Boolean {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Boolean.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Boolean.data)
    pub data: bool,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Boolean.special_fields)
