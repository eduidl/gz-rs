...
//! Generated file from `gz/msgs/joint.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Joint)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Joint {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Joint.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Joint.id)
    pub id: u32,
    // @@protoc_insertion_point(field:gz.msgs.Joint.type)
    pub type_: ::protobuf::EnumOrUnknown<joint::Type>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.parent)
    pub parent: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Joint.parent_id)
    pub parent_id: u32,
    // @@protoc_insertion_point(field:gz.msgs.Joint.child)
    pub child: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Joint.child_id)
    pub child_id: u32,
    // @@protoc_insertion_point(field:gz.msgs.Joint.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.axis1)
    pub axis1: ::protobuf::MessageField<super::axis::Axis>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.axis2)
    pub axis2: ::protobuf::MessageField<super::axis::Axis>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.cfm)
    pub cfm: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.bounce)
    pub bounce: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.fudge_factor)
    pub fudge_factor: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.limit_cfm)
    pub limit_cfm: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.limit_erp)
    pub limit_erp: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.suspension_cfm)
    pub suspension_cfm: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.suspension_erp)
    pub suspension_erp: f64,
    // @@protoc_insertion_point(field:gz.msgs.Joint.gearbox)
    pub gearbox: ::protobuf::MessageField<joint::Gearbox>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.screw)
    pub screw: ::protobuf::MessageField<joint::Screw>,
    // @@protoc_insertion_point(field:gz.msgs.Joint.sensor)
    pub sensor: ::std::vec::Vec<super::sensor::Sensor>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Joint.special_fields)
...
pub mod joint {
    #[derive(::gz_msgs_common::GzMessage)]
    // @@protoc_insertion_point(message:gz.msgs.Joint.Gearbox)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Gearbox {
        // message fields
        // @@protoc_insertion_point(field:gz.msgs.Joint.Gearbox.gearbox_reference_body)
        pub gearbox_reference_body: ::std::string::String,
        // @@protoc_insertion_point(field:gz.msgs.Joint.Gearbox.gearbox_ratio)
        pub gearbox_ratio: f64,
        // special fields
        // @@protoc_insertion_point(special_field:gz.msgs.Joint.Gearbox.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    #[derive(::gz_msgs_common::GzMessage)]
    // @@protoc_insertion_point(message:gz.msgs.Joint.Screw)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Screw {
        // message fields
        // @@protoc_insertion_point(field:gz.msgs.Joint.Screw.thread_pitch)
        pub thread_pitch: f64,
        // special fields
        // @@protoc_insertion_point(special_field:gz.msgs.Joint.Screw.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    // @@protoc_insertion_point(enum:gz.msgs.Joint.Type)
    pub enum Type {
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.REVOLUTE)
        REVOLUTE = 0,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.REVOLUTE2)
        REVOLUTE2 = 1,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.PRISMATIC)
        PRISMATIC = 2,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.UNIVERSAL)
        UNIVERSAL = 3,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.BALL)
        BALL = 4,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.SCREW)
        SCREW = 5,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.GEARBOX)
        GEARBOX = 6,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.FIXED)
        FIXED = 7,
        // @@protoc_insertion_point(enum_value:gz.msgs.Joint.Type.CONTINUOUS)
        CONTINUOUS = 8,
    }
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_i32(value: i32) -> ::std::option::Option<Type> {
            match value {
                ...
                8 => ::std::option::Option::Some(Type::CONTINUOUS),
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "REVOLUTE" => ::std::option::Option::Some(Type::REVOLUTE),
                "REVOLUTE2" => ::std::option::Option::Some(Type::REVOLUTE2),
                "PRISMATIC" => ::std::option::Option::Some(Type::PRISMATIC),
                "UNIVERSAL" => ::std::option::Option::Some(Type::UNIVERSAL),
                "BALL" => ::std::option::Option::Some(Type::BALL),
                "SCREW" => ::std::option::Option::Some(Type::SCREW),
                "GEARBOX" => ::std::option::Option::Some(Type::GEARBOX),
                "FIXED" => ::std::option::Option::Some(Type::FIXED),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12gz/msgs/axis.proto\x1a\x12gz/msgs/pose.proto\x1a\x14gz/msgs/sensor.p\
    ...
    \x20\x01(\x01R\x06bounce\x12!\n\x0cfudge_factor\x18\x0e\x20\x01(\x01R\
    \x0bfudgeFactor\x12\x1b\n\tlimit_cfm\x18\x0f\x20\x01(\x01R\x08limitCfm\
    \x12\x1b\n\tlimit_erp\x18\x10\x20\x01(\x01R\x08limitErp\x12%\n\x0esuspen\
    sion_cfm\x18\x11\x20\x01(\x01R\rsuspensionCfm\x12%\n\x0esuspension_erp\
    \x18\x12\x20\x01(\x01R\rsuspensionErp\x120\n\x07gearbox\x18\x13\x20\x01(\
    \x0b2\x16.gz.msgs.Joint.GearboxR\x07gearbox\x12*\n\x05screw\x18\x14\x20\
    \x01(\x0b2\x14.gz.msgs.Joint.ScrewR\x05screw\x12'\n\x06sensor\x18\x15\
    \x20\x03(\x0b2\x0f.gz.msgs.SensorR\x06sensor\x1ad\n\x07Gearbox\x124\n\
    \x16gearbox_reference_body\x18\x01\x20\x01(\tR\x14gearboxReferenceBody\
