...
//! Generated file from `gz/msgs/magnetometer_sensor.proto`
...
// @@protoc_insertion_point(message:gz.msgs.MagnetometerSensor)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct MagnetometerSensor {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.MagnetometerSensor.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.MagnetometerSensor.x_noise)
    pub x_noise: ::protobuf::MessageField<super::sensor_noise::SensorNoise>,
    // @@protoc_insertion_point(field:gz.msgs.MagnetometerSensor.y_noise)
    pub y_noise: ::protobuf::MessageField<super::sensor_noise::SensorNoise>,
    // @@protoc_insertion_point(field:gz.msgs.MagnetometerSensor.z_noise)
    pub z_noise: ::protobuf::MessageField<super::sensor_noise::SensorNoise>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.MagnetometerSensor.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!gz/msgs/magnetometer_sensor.proto\x12\x07gz.msgs\x1a\x14gz/msgs/heade\
    r.proto\x1a\x1agz/msgs/sensor_noise.proto\"\xca\x01\n\x12MagnetometerSen\
    sor\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\x06header\
    \x12-\n\x07x_noise\x18\x02\x20\x01(\x0b2\x14.gz.msgs.SensorNoiseR\x06xNo\
    ise\x12-\n\x07y_noise\x18\x03\x20\x01(\x0b2\x14.gz.msgs.SensorNoiseR\x06\
    yNoise\x12-\n\x07z_noise\x18\x04\x20\x01(\x0b2\x14.gz.msgs.SensorNoiseR\
    \x06zNoiseB'\n\x0bcom.gz.msgsB\x18MagnetometerSensorProtosb\x06proto3\
";
