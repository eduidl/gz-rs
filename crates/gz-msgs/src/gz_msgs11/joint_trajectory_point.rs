...
impl ::protobuf::Message for JointTrajectoryPoint {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_double_size(1, &self.positions);
        my_size += ::protobuf::rt::vec_packed_double_size(2, &self.velocities);
        my_size += ::protobuf::rt::vec_packed_double_size(3, &self.accelerations);
        my_size += ::protobuf::rt::vec_packed_double_size(4, &self.effort);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_double(1, &self.positions)?;
        os.write_repeated_packed_double(2, &self.velocities)?;
        os.write_repeated_packed_double(3, &self.accelerations)?;
        os.write_repeated_packed_double(4, &self.effort)?;
        if let Some(v) = self.time_from_start.as_ref() {
