...
//! Generated file from `gz/msgs/gps.proto`
...
// @@protoc_insertion_point(message:gz.msgs.GPS)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GPS {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.GPS.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.GPS.link_name)
    pub link_name: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.GPS.latitude_deg)
    pub latitude_deg: f64,
    // @@protoc_insertion_point(field:gz.msgs.GPS.longitude_deg)
    pub longitude_deg: f64,
    // @@protoc_insertion_point(field:gz.msgs.GPS.altitude)
    pub altitude: f64,
    // @@protoc_insertion_point(field:gz.msgs.GPS.velocity_east)
    pub velocity_east: f64,
    // @@protoc_insertion_point(field:gz.msgs.GPS.velocity_north)
    pub velocity_north: f64,
    // @@protoc_insertion_point(field:gz.msgs.GPS.velocity_up)
    pub velocity_up: f64,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.GPS.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11gz/msgs/gps.proto\x12\x07gz.msgs\x1a\x14gz/msgs/header.proto\"\x9c\
    \x02\n\x03GPS\x12'\n\x06header\x18\x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\
    \x06header\x12\x1b\n\tlink_name\x18\x02\x20\x01(\tR\x08linkName\x12!\n\
    \x0clatitude_deg\x18\x03\x20\x01(\x01R\x0blatitudeDeg\x12#\n\rlongitude_\
    deg\x18\x04\x20\x01(\x01R\x0clongitudeDeg\x12\x1a\n\x08altitude\x18\x05\
    \x20\x01(\x01R\x08altitude\x12#\n\rvelocity_east\x18\x06\x20\x01(\x01R\
    \x0cvelocityEast\x12%\n\x0evelocity_north\x18\x07\x20\x01(\x01R\rvelocit\
    yNorth\x12\x1f\n\x0bvelocity_up\x18\x08\x20\x01(\x01R\nvelocityUpB\x18\n\
    \x0bcom.gz.msgsB\tGPSProtosb\x06proto3\
";
