...
//! Generated file from `gz/msgs/pointcloud.proto`
...
// @@protoc_insertion_point(message:gz.msgs.PointCloud)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct PointCloud {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.PointCloud.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.PointCloud.points)
    pub points: ::std::vec::Vec<super::vector3d::Vector3d>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.PointCloud.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18gz/msgs/pointcloud.proto\x12\x07gz.msgs\x1a\x16gz/msgs/vector3d.pr\
    oto\x1a\x14gz/msgs/header.proto\"`\n\nPointCloud\x12'\n\x06header\x18\
    \x01\x20\x01(\x0b2\x0f.gz.msgs.HeaderR\x06header\x12)\n\x06points\x18\
    \x02\x20\x03(\x0b2\x11.gz.msgs.Vector3dR\x06pointsB\x1f\n\x0bcom.gz.msgs\
    B\x10PointCloudProtosb\x06proto3\
";
