...
pub mod lens {
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "TYPE_NOT_SPECIFIED" => ::std::option::Option::Some(Type::TYPE_NOT_SPECIFIED),
                "GNOMONICAL" => ::std::option::Option::Some(Type::GNOMONICAL),
                "STEREOGRAPHIC" => ::std::option::Option::Some(Type::STEREOGRAPHIC),
                "EQUIDISTANT" => ::std::option::Option::Some(Type::EQUIDISTANT),
                "EQUISOLID_ANGLE" => ::std::option::Option::Some(Type::EQUISOLID_ANGLE),
                "ORTHOGRAPHIC" => ::std::option::Option::Some(Type::ORTHOGRAPHIC),
                "CUSTOM" => ::std::option::Option::Some(Type::CUSTOM),
                _ => ::std::option::Option::None
            }
        }
    ...
    impl ::protobuf::Enum for FunctionType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<FunctionType> {
            match str {
                "FUNCTION_NOT_SPECIFIED" => ::std::option::Option::Some(FunctionType::FUNCTION_NOT_SPECIFIED),
                "SIN" => ::std::option::Option::Some(FunctionType::SIN),
                "TAN" => ::std::option::Option::Some(FunctionType::TAN),
                "ID" => ::std::option::Option::Some(FunctionType::ID),
                _ => ::std::option::Option::None
            }
        }
