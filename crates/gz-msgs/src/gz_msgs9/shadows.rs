...
//! Generated file from `gz/msgs/shadows.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Shadows)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Shadows {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Shadows.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Shadows.type)
    pub type_: ::protobuf::EnumOrUnknown<shadows::ShadowType>,
    // @@protoc_insertion_point(field:gz.msgs.Shadows.color)
    pub color: ::protobuf::MessageField<super::color::Color>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Shadows.special_fields)
...
pub mod shadows {
    ...
    // @@protoc_insertion_point(enum:gz.msgs.Shadows.ShadowType)
    pub enum ShadowType {
        // @@protoc_insertion_point(enum_value:gz.msgs.Shadows.ShadowType.STENCIL_ADDITIVE)
        STENCIL_ADDITIVE = 0,
        // @@protoc_insertion_point(enum_value:gz.msgs.Shadows.ShadowType.STENCIL_MODULATIVE)
        STENCIL_MODULATIVE = 1,
        // @@protoc_insertion_point(enum_value:gz.msgs.Shadows.ShadowType.TEXTURE_ADDITIVE)
        TEXTURE_ADDITIVE = 2,
        // @@protoc_insertion_point(enum_value:gz.msgs.Shadows.ShadowType.TEXTURE_MODULATIVE)
