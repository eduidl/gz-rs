...
//! Generated file from `gz/msgs/marker.proto`
...
// @@protoc_insertion_point(message:gz.msgs.Marker)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Marker {
    // message fields
    // @@protoc_insertion_point(field:gz.msgs.Marker.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.action)
    pub action: ::protobuf::EnumOrUnknown<marker::Action>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.ns)
    pub ns: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Marker.id)
    pub id: u64,
    // @@protoc_insertion_point(field:gz.msgs.Marker.layer)
    pub layer: i32,
    // @@protoc_insertion_point(field:gz.msgs.Marker.type)
    pub type_: ::protobuf::EnumOrUnknown<marker::Type>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.lifetime)
    pub lifetime: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.scale)
    pub scale: ::protobuf::MessageField<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.material)
    pub material: ::protobuf::MessageField<super::material::Material>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.point)
    pub point: ::std::vec::Vec<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.text)
    pub text: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Marker.parent)
    pub parent: ::std::string::String,
    // @@protoc_insertion_point(field:gz.msgs.Marker.visibility)
    pub visibility: ::protobuf::EnumOrUnknown<marker::Visibility>,
    // @@protoc_insertion_point(field:gz.msgs.Marker.materials)
    pub materials: ::std::vec::Vec<super::material::Material>,
    // special fields
    // @@protoc_insertion_point(special_field:gz.msgs.Marker.special_fields)
...
pub mod marker {
    ...
    // @@protoc_insertion_point(enum:gz.msgs.Marker.Type)
    pub enum Type {
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.NONE)
        NONE = 0,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.BOX)
        BOX = 1,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.CYLINDER)
        CYLINDER = 2,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.LINE_LIST)
        LINE_LIST = 4,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.LINE_STRIP)
        LINE_STRIP = 3,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.POINTS)
        POINTS = 5,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.SPHERE)
        SPHERE = 6,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.TEXT)
        TEXT = 7,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.TRIANGLE_FAN)
        TRIANGLE_FAN = 8,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.TRIANGLE_LIST)
        TRIANGLE_LIST = 9,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.TRIANGLE_STRIP)
        TRIANGLE_STRIP = 10,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.CONE)
        CONE = 11,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.ARROW)
        ARROW = 12,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.AXIS)
        AXIS = 13,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.CAPSULE)
        CAPSULE = 14,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Type.ELLIPSOID)
        ELLIPSOID = 15,
    }
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                ...
                "TEXT" => ::std::option::Option::Some(Type::TEXT),
                "TRIANGLE_FAN" => ::std::option::Option::Some(Type::TRIANGLE_FAN),
                "TRIANGLE_LIST" => ::std::option::Option::Some(Type::TRIANGLE_LIST),
                "TRIANGLE_STRIP" => ::std::option::Option::Some(Type::TRIANGLE_STRIP),
    ...
    #[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
    // @@protoc_insertion_point(enum:gz.msgs.Marker.Visibility)
    pub enum Visibility {
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Visibility.GUI)
        GUI = 0,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Visibility.ALL)
        ALL = 1,
    }
    ...
    impl ::protobuf::Enum for Visibility {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Visibility> {
            match str {
                "GUI" => ::std::option::Option::Some(Visibility::GUI),
                "ALL" => ::std::option::Option::Some(Visibility::ALL),
                _ => ::std::option::Option::None
            }
        }
    ...
    #[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
    // @@protoc_insertion_point(enum:gz.msgs.Marker.Action)
    pub enum Action {
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Action.ADD_MODIFY)
        ADD_MODIFY = 0,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Action.DELETE_MARKER)
        DELETE_MARKER = 1,
        // @@protoc_insertion_point(enum_value:gz.msgs.Marker.Action.DELETE_ALL)
        DELETE_ALL = 2,
    }
    ...
    impl ::protobuf::Enum for Action {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Action> {
            match str {
                "ADD_MODIFY" => ::std::option::Option::Some(Action::ADD_MODIFY),
                "DELETE_MARKER" => ::std::option::Option::Some(Action::DELETE_MARKER),
                "DELETE_ALL" => ::std::option::Option::Some(Action::DELETE_ALL),
                _ => ::std::option::Option::None
            }
        }
