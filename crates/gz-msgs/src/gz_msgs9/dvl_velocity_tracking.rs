...
pub mod dvlvelocity_tracking {
    ...
    impl ::protobuf::Enum for DVLType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<DVLType> {
            match str {
                "DVL_TYPE_UNSPECIFIED" => ::std::option::Option::Some(DVLType::DVL_TYPE_UNSPECIFIED),
                "DVL_TYPE_PISTON" => ::std::option::Option::Some(DVLType::DVL_TYPE_PISTON),
                "DVL_TYPE_PHASED_ARRAY" => ::std::option::Option::Some(DVLType::DVL_TYPE_PHASED_ARRAY),
                _ => ::std::option::Option::None
            }
        }
