...
//! Generated file from `ignition/msgs/pointcloud_packed.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.PointCloudPacked)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct PointCloudPacked {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.field)
    pub field: ::std::vec::Vec<point_cloud_packed::Field>,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.height)
    pub height: u32,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.width)
    pub width: u32,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.is_bigendian)
    pub is_bigendian: bool,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.point_step)
    pub point_step: u32,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.row_step)
    pub row_step: u32,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.data)
    pub data: ::std::vec::Vec<u8>,
    // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.is_dense)
    pub is_dense: bool,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.PointCloudPacked.special_fields)
...
pub mod point_cloud_packed {
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.PointCloudPacked.Field)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Field {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.Field.name)
        pub name: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.Field.offset)
        pub offset: u32,
        // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.Field.datatype)
        pub datatype: ::protobuf::EnumOrUnknown<field::DataType>,
        // @@protoc_insertion_point(field:ignition.msgs.PointCloudPacked.Field.count)
        pub count: u32,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.PointCloudPacked.Field.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    pub mod field {
        ...
        // @@protoc_insertion_point(enum:ignition.msgs.PointCloudPacked.Field.DataType)
        pub enum DataType {
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.INT8)
            INT8 = 0,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.UINT8)
            UINT8 = 1,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.INT16)
            INT16 = 2,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.UINT16)
            UINT16 = 3,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.INT32)
            INT32 = 4,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.UINT32)
            UINT32 = 5,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.FLOAT32)
            FLOAT32 = 6,
            // @@protoc_insertion_point(enum_value:ignition.msgs.PointCloudPacked.Field.DataType.FLOAT64)
            FLOAT64 = 7,
        }
        ...
        impl ::protobuf::Enum for DataType {
            ...
            fn from_str(str: &str) -> ::std::option::Option<DataType> {
                match str {
                    ...
                    "FLOAT32" => ::std::option::Option::Some(DataType::FLOAT32),
                    "FLOAT64" => ::std::option::Option::Some(DataType::FLOAT64),
                    _ => ::std::option::Option::None
                }
            }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ion/msgs/header.proto\"\xb9\x04\n\x10PointCloudPacked\x12-\n\x06header\
    \x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12;\n\x05fie\
    ld\x18\x02\x20\x03(\x0b2%.ignition.msgs.PointCloudPacked.FieldR\x05field\
    \x12\x16\n\x06height\x18\x03\x20\x01(\rR\x06height\x12\x14\n\x05width\
    \x18\x04\x20\x01(\rR\x05width\x12!\n\x0cis_bigendian\x18\x05\x20\x01(\
    \x08R\x0bisBigendian\x12\x1d\n\npoint_step\x18\x06\x20\x01(\rR\tpointSte\
    p\x12\x19\n\x08row_step\x18\x07\x20\x01(\rR\x07rowStep\x12\x12\n\x04data\
    \x18\x08\x20\x01(\x0cR\x04data\x12\x19\n\x08is_dense\x18\t\x20\x01(\x08R\
    \x07isDense\x1a\xfe\x01\n\x05Field\x12\x12\n\x04name\x18\x01\x20\x01(\tR\
    \x04name\x12\x16\n\x06offset\x18\x02\x20\x01(\rR\x06offset\x12J\n\x08dat\
    atype\x18\x03\x20\x01(\x0e2..ignition.msgs.PointCloudPacked.Field.DataTy\
    peR\x08datatype\x12\x14\n\x05count\x18\x04\x20\x01(\rR\x05count\"g\n\x08\
