...
//! Generated file from `ignition/msgs/log_control.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.LogControl)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LogControl {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.start)
    pub start: bool,
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.stop)
    pub stop: bool,
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.paused)
    pub paused: bool,
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.base_path)
    pub base_path: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.encoding)
    pub encoding: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.LogControl.record_resources)
    pub record_resources: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.LogControl.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fignition/msgs/log_control.proto\x12\rignition.msgs\x1a\x1aignition\
    /msgs/header.proto\"\xe1\x01\n\nLogControl\x12-\n\x06header\x18\x01\x20\
    \x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x14\n\x05start\x18\
    \x02\x20\x01(\x08R\x05start\x12\x12\n\x04stop\x18\x03\x20\x01(\x08R\x04s\
    top\x12\x16\n\x06paused\x18\x04\x20\x01(\x08R\x06paused\x12\x1b\n\tbase_\
    path\x18\x05\x20\x01(\tR\x08basePath\x12\x1a\n\x08encoding\x18\x06\x20\
    \x01(\tR\x08encoding\x12)\n\x10record_resources\x18\x07\x20\x01(\tR\x0fr\
    ecordResourcesB%\n\x11com.ignition.msgsB\x10LogControlProtosb\x06proto3\
";
