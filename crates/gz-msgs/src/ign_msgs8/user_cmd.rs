...
//! Generated file from `ignition/msgs/user_cmd.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.UserCmd)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct UserCmd {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.id)
    pub id: u32,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.description)
    pub description: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.type)
    pub type_: ::protobuf::EnumOrUnknown<user_cmd::Type>,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.model)
    pub model: ::std::vec::Vec<super::model::Model>,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.light)
    pub light: ::std::vec::Vec<super::light::Light>,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.entity_name)
    pub entity_name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.world_control)
    pub world_control: ::protobuf::MessageField<super::world_control::WorldControl>,
    // @@protoc_insertion_point(field:ignition.msgs.UserCmd.wrench)
    pub wrench: ::protobuf::MessageField<super::wrench::Wrench>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.UserCmd.special_fields)
...
pub mod user_cmd {
    ...
    // @@protoc_insertion_point(enum:ignition.msgs.UserCmd.Type)
    pub enum Type {
        // @@protoc_insertion_point(enum_value:ignition.msgs.UserCmd.Type.MOVING)
        MOVING = 0,
        // @@protoc_insertion_point(enum_value:ignition.msgs.UserCmd.Type.WORLD_CONTROL)
        WORLD_CONTROL = 1,
        // @@protoc_insertion_point(enum_value:ignition.msgs.UserCmd.Type.WRENCH)
        WRENCH = 2,
        // @@protoc_insertion_point(enum_value:ignition.msgs.UserCmd.Type.SCALING)
        SCALING = 3,
    }
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "MOVING" => ::std::option::Option::Some(Type::MOVING),
                "WORLD_CONTROL" => ::std::option::Option::Some(Type::WORLD_CONTROL),
                "WRENCH" => ::std::option::Option::Some(Type::WRENCH),
                "SCALING" => ::std::option::Option::Some(Type::SCALING),
                _ => ::std::option::Option::None
            }
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gs/light.proto\x1a\x19ignition/msgs/model.proto\x1a!ignition/msgs/world_\
    control.proto\x1a\x1aignition/msgs/wrench.proto\x1a\x1aignition/msgs/hea\
    ...
    control\x18\x08\x20\x01(\x0b2\x1b.ignition.msgs.WorldControlR\x0cworldCo\
    ntrol\x12-\n\x06wrench\x18\t\x20\x01(\x0b2\x15.ignition.msgs.WrenchR\x06\
    wrench\">\n\x04Type\x12\n\n\x06MOVING\x10\0\x12\x11\n\rWORLD_CONTROL\x10\
    \x01\x12\n\n\x06WRENCH\x10\x02\x12\x0b\n\x07SCALING\x10\x03B\"\n\x11com.\
    ignition.msgsB\rUserCmdProtosb\x06proto3\
";
