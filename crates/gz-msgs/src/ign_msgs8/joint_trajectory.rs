...
//! Generated file from `ignition/msgs/joint_trajectory.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.JointTrajectory)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct JointTrajectory {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.JointTrajectory.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.JointTrajectory.joint_names)
    pub joint_names: ::std::vec::Vec<::std::string::String>,
    // @@protoc_insertion_point(field:ignition.msgs.JointTrajectory.points)
    pub points: ::std::vec::Vec<super::joint_trajectory_point::JointTrajectoryPoint>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.JointTrajectory.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$ignition/msgs/joint_trajectory.proto\x12\rignition.msgs\x1a\x1aigniti\
    on/msgs/header.proto\x1a*ignition/msgs/joint_trajectory_point.proto\"\
    \x9e\x01\n\x0fJointTrajectory\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15\
    .ignition.msgs.HeaderR\x06header\x12\x1f\n\x0bjoint_names\x18\x02\x20\
    \x03(\tR\njointNames\x12;\n\x06points\x18\x03\x20\x03(\x0b2#.ignition.ms\
    gs.JointTrajectoryPointR\x06pointsB*\n\x11com.ignition.msgsB\x15JointTra\
    jectoryProtosb\x06proto3\
";
