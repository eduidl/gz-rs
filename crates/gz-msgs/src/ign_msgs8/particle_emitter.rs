...
//! Generated file from `ignition/msgs/particle_emitter.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.ParticleEmitter)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ParticleEmitter {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.id)
    pub id: u32,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.type)
    pub type_: ::protobuf::EnumOrUnknown<particle_emitter::EmitterType>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.size)
    pub size: ::protobuf::MessageField<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.rate)
    pub rate: ::protobuf::MessageField<super::float::Float>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.duration)
    pub duration: ::protobuf::MessageField<super::float::Float>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.emitting)
    pub emitting: ::protobuf::MessageField<super::boolean::Boolean>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.particle_size)
    pub particle_size: ::protobuf::MessageField<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.lifetime)
    pub lifetime: ::protobuf::MessageField<super::float::Float>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.material)
    pub material: ::protobuf::MessageField<super::material::Material>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.min_velocity)
    pub min_velocity: ::protobuf::MessageField<super::float::Float>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.max_velocity)
    pub max_velocity: ::protobuf::MessageField<super::float::Float>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.color_start)
    pub color_start: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.color_end)
    pub color_end: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.scale_rate)
    pub scale_rate: ::protobuf::MessageField<super::float::Float>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.color_range_image)
    pub color_range_image: ::protobuf::MessageField<super::stringmsg::StringMsg>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.topic)
    pub topic: ::protobuf::MessageField<super::stringmsg::StringMsg>,
    // @@protoc_insertion_point(field:ignition.msgs.ParticleEmitter.particle_scatter_ratio)
    pub particle_scatter_ratio: ::protobuf::MessageField<super::float::Float>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.ParticleEmitter.special_fields)
...
pub mod particle_emitter {
    ...
    // @@protoc_insertion_point(enum:ignition.msgs.ParticleEmitter.EmitterType)
    pub enum EmitterType {
        // @@protoc_insertion_point(enum_value:ignition.msgs.ParticleEmitter.EmitterType.POINT)
        POINT = 0,
        // @@protoc_insertion_point(enum_value:ignition.msgs.ParticleEmitter.EmitterType.BOX)
        BOX = 1,
        // @@protoc_insertion_point(enum_value:ignition.msgs.ParticleEmitter.EmitterType.CYLINDER)
        CYLINDER = 2,
        // @@protoc_insertion_point(enum_value:ignition.msgs.ParticleEmitter.EmitterType.ELLIPSOID)
        ELLIPSOID = 3,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$ignition/msgs/particle_emitter.proto\x12\rignition.msgs\x1a\x1bigniti\
    on/msgs/boolean.proto\x1a\x19ignition/msgs/color.proto\x1a\x19ignition/m\
    sgs/float.proto\x1a\x1aignition/msgs/header.proto\x1a\x1cignition/msgs/m\
    aterial.proto\x1a\x18ignition/msgs/pose.proto\x1a\x1dignition/msgs/strin\
    gmsg.proto\x1a\x1cignition/msgs/vector3d.proto\"\xc2\x08\n\x0fParticleEm\
    itter\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\
    \x06header\x12\x12\n\x04name\x18\x02\x20\x01(\tR\x04name\x12\x0e\n\x02id\
    \x18\x03\x20\x01(\rR\x02id\x12>\n\x04type\x18\x04\x20\x01(\x0e2*.ignitio\
    n.msgs.ParticleEmitter.EmitterTypeR\x04type\x12'\n\x04pose\x18\x05\x20\
    \x01(\x0b2\x13.ignition.msgs.PoseR\x04pose\x12+\n\x04size\x18\x06\x20\
    \x01(\x0b2\x17.ignition.msgs.Vector3dR\x04size\x12(\n\x04rate\x18\x07\
    \x20\x01(\x0b2\x14.ignition.msgs.FloatR\x04rate\x120\n\x08duration\x18\
    \x08\x20\x01(\x0b2\x14.ignition.msgs.FloatR\x08duration\x122\n\x08emitti\
    ng\x18\t\x20\x01(\x0b2\x16.ignition.msgs.BooleanR\x08emitting\x12<\n\rpa\
    rticle_size\x18\n\x20\x01(\x0b2\x17.ignition.msgs.Vector3dR\x0cparticleS\
    ize\x120\n\x08lifetime\x18\x0b\x20\x01(\x0b2\x14.ignition.msgs.FloatR\
    \x08lifetime\x123\n\x08material\x18\x0c\x20\x01(\x0b2\x17.ignition.msgs.\
    MaterialR\x08material\x127\n\x0cmin_velocity\x18\r\x20\x01(\x0b2\x14.ign\
    ition.msgs.FloatR\x0bminVelocity\x127\n\x0cmax_velocity\x18\x0e\x20\x01(\
    \x0b2\x14.ignition.msgs.FloatR\x0bmaxVelocity\x125\n\x0bcolor_start\x18\
    \x0f\x20\x01(\x0b2\x14.ignition.msgs.ColorR\ncolorStart\x121\n\tcolor_en\
    d\x18\x10\x20\x01(\x0b2\x14.ignition.msgs.ColorR\x08colorEnd\x123\n\nsca\
    le_rate\x18\x11\x20\x01(\x0b2\x14.ignition.msgs.FloatR\tscaleRate\x12D\n\
    \x11color_range_image\x18\x12\x20\x01(\x0b2\x18.ignition.msgs.StringMsgR\
    \x0fcolorRangeImage\x12.\n\x05topic\x18\x13\x20\x01(\x0b2\x18.ignition.m\
    sgs.StringMsgR\x05topic\x12J\n\x16particle_scatter_ratio\x18\x14\x20\x01\
    (\x0b2\x14.ignition.msgs.FloatR\x14particleScatterRatio\">\n\x0bEmitterT\
    ype\x12\t\n\x05POINT\x10\0\x12\x07\n\x03BOX\x10\x01\x12\x0c\n\x08CYLINDE\
    R\x10\x02\x12\r\n\tELLIPSOID\x10\x03B*\n\x11com.ignition.msgsB\x15Partic\
    leEmitterProtosb\x06proto3\
";
