...
//! Generated file from `ignition/msgs/log_playback_stats.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.LogPlaybackStatistics)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LogPlaybackStatistics {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.LogPlaybackStatistics.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.LogPlaybackStatistics.start_time)
    pub start_time: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:ignition.msgs.LogPlaybackStatistics.end_time)
    pub end_time: ::protobuf::MessageField<super::time::Time>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.LogPlaybackStatistics.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&ignition/msgs/log_playback_stats.proto\x12\rignition.msgs\x1a\x18igni\
    tion/msgs/time.proto\x1a\x1aignition/msgs/header.proto\"\xaa\x01\n\x15Lo\
    gPlaybackStatistics\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.\
    msgs.HeaderR\x06header\x122\n\nstart_time\x18\x02\x20\x01(\x0b2\x13.igni\
    tion.msgs.TimeR\tstartTime\x12.\n\x08end_time\x18\x03\x20\x01(\x0b2\x13.\
    ignition.msgs.TimeR\x07endTimeB0\n\x11com.ignition.msgsB\x1bLogPlaybackS\
    tatisticsProtosb\x06proto3\
";
