...
//! Generated file from `ignition/msgs/camera_info.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.CameraInfo)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CameraInfo {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.width)
    pub width: u32,
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.height)
    pub height: u32,
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.distortion)
    pub distortion: ::protobuf::MessageField<camera_info::Distortion>,
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.intrinsics)
    pub intrinsics: ::protobuf::MessageField<camera_info::Intrinsics>,
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.projection)
    pub projection: ::protobuf::MessageField<camera_info::Projection>,
    // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.rectification_matrix)
    pub rectification_matrix: ::std::vec::Vec<f64>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.CameraInfo.special_fields)
...
pub mod camera_info {
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.CameraInfo.Distortion)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Distortion {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.Distortion.model)
        pub model: ::protobuf::EnumOrUnknown<distortion::DistortionModelType>,
        // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.Distortion.k)
        pub k: ::std::vec::Vec<f64>,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.CameraInfo.Distortion.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    impl ::protobuf::Message for Distortion {
        ...
        fn compute_size(&self) -> u64 {
            ...
            my_size += ::protobuf::rt::vec_packed_double_size(2, &self.k);
            my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
            self.special_fields.cached_size().set(my_size as u32);
            my_size
        }
        ...
        fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
            ...
            os.write_repeated_packed_double(2, &self.k)?;
            os.write_unknown_fields(self.special_fields.unknown_fields())?;
            ::std::result::Result::Ok(())
        }
    ...
    pub mod distortion {
        ...
        // @@protoc_insertion_point(enum:ignition.msgs.CameraInfo.Distortion.DistortionModelType)
        pub enum DistortionModelType {
            // @@protoc_insertion_point(enum_value:ignition.msgs.CameraInfo.Distortion.DistortionModelType.PLUMB_BOB)
            PLUMB_BOB = 0,
            // @@protoc_insertion_point(enum_value:ignition.msgs.CameraInfo.Distortion.DistortionModelType.RATIONAL_POLYNOMIAL)
            RATIONAL_POLYNOMIAL = 1,
            // @@protoc_insertion_point(enum_value:ignition.msgs.CameraInfo.Distortion.DistortionModelType.EQUIDISTANT)
            EQUIDISTANT = 2,
        }
        ...
        impl ::protobuf::Enum for DistortionModelType {
            ...
            fn from_str(str: &str) -> ::std::option::Option<DistortionModelType> {
                match str {
                    "PLUMB_BOB" => ::std::option::Option::Some(DistortionModelType::PLUMB_BOB),
                    "RATIONAL_POLYNOMIAL" => ::std::option::Option::Some(DistortionModelType::RATIONAL_POLYNOMIAL),
                    "EQUIDISTANT" => ::std::option::Option::Some(DistortionModelType::EQUIDISTANT),
                    _ => ::std::option::Option::None
                }
            }
    ...
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.CameraInfo.Intrinsics)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Intrinsics {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.Intrinsics.k)
        pub k: ::std::vec::Vec<f64>,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.CameraInfo.Intrinsics.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    impl ::protobuf::Message for Intrinsics {
        ...
        fn compute_size(&self) -> u64 {
            let mut my_size = 0;
            my_size += ::protobuf::rt::vec_packed_double_size(1, &self.k);
            my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
            self.special_fields.cached_size().set(my_size as u32);
            my_size
        }
        ...
        fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
            os.write_repeated_packed_double(1, &self.k)?;
            os.write_unknown_fields(self.special_fields.unknown_fields())?;
            ::std::result::Result::Ok(())
        }
    ...
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.CameraInfo.Projection)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Projection {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.CameraInfo.Projection.p)
        pub p: ::std::vec::Vec<f64>,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.CameraInfo.Projection.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    impl ::protobuf::Message for Projection {
        ...
        fn compute_size(&self) -> u64 {
            let mut my_size = 0;
            my_size += ::protobuf::rt::vec_packed_double_size(1, &self.p);
            my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
            self.special_fields.cached_size().set(my_size as u32);
            my_size
        }
        ...
        fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
            os.write_repeated_packed_double(1, &self.p)?;
            os.write_unknown_fields(self.special_fields.unknown_fields())?;
            ::std::result::Result::Ok(())
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fignition/msgs/camera_info.proto\x12\rignition.msgs\x1a\x1aignition\
    /msgs/header.proto\"\xe7\x04\n\nCameraInfo\x12-\n\x06header\x18\x01\x20\
    \x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x14\n\x05width\x18\
    \x02\x20\x01(\rR\x05width\x12\x16\n\x06height\x18\x03\x20\x01(\rR\x06hei\
    ght\x12D\n\ndistortion\x18\x04\x20\x01(\x0b2$.ignition.msgs.CameraInfo.D\
    istortionR\ndistortion\x12D\n\nintrinsics\x18\x05\x20\x01(\x0b2$.ignitio\
    n.msgs.CameraInfo.IntrinsicsR\nintrinsics\x12D\n\nprojection\x18\x06\x20\
    \x01(\x0b2$.ignition.msgs.CameraInfo.ProjectionR\nprojection\x125\n\x14r\
    ectification_matrix\x18\x07\x20\x03(\x01R\x13rectificationMatrixB\x02\
    \x10\x01\x1a\xba\x01\n\nDistortion\x12N\n\x05model\x18\x01\x20\x01(\x0e2\
    8.ignition.msgs.CameraInfo.Distortion.DistortionModelTypeR\x05model\x12\
    \x0c\n\x01k\x18\x02\x20\x03(\x01R\x01k\"N\n\x13DistortionModelType\x12\r\
    \n\tPLUMB_BOB\x10\0\x12\x17\n\x13RATIONAL_POLYNOMIAL\x10\x01\x12\x0f\n\
    \x0bEQUIDISTANT\x10\x02\x1a\x1a\n\nIntrinsics\x12\x0c\n\x01k\x18\x01\x20\
    \x03(\x01R\x01k\x1a\x1a\n\nProjection\x12\x0c\n\x01p\x18\x01\x20\x03(\
    \x01R\x01pB%\n\x11com.ignition.msgsB\x10CameraInfoProtosb\x06proto3\
";
