...
//! Generated file from `ignition/msgs/joint_animation.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.JointAnimation)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct JointAnimation {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.JointAnimation.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.JointAnimation.model_name)
    pub model_name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.JointAnimation.joint)
    pub joint: ::std::vec::Vec<joint_animation::Joint>,
    // @@protoc_insertion_point(field:ignition.msgs.JointAnimation.time)
    pub time: ::std::vec::Vec<super::time::Time>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.JointAnimation.special_fields)
...
pub mod joint_animation {
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.JointAnimation.Joint)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Joint {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.JointAnimation.Joint.name)
        pub name: ::std::vec::Vec<::std::string::String>,
        // @@protoc_insertion_point(field:ignition.msgs.JointAnimation.Joint.angle)
        pub angle: ::std::vec::Vec<f64>,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.JointAnimation.Joint.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    impl ::protobuf::Message for Joint {
        ...
        fn compute_size(&self) -> u64 {
            ...
            my_size += ::protobuf::rt::vec_packed_double_size(2, &self.angle);
            my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
            self.special_fields.cached_size().set(my_size as u32);
            my_size
        }
        ...
        fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
            ...
            os.write_repeated_packed_double(2, &self.angle)?;
            os.write_unknown_fields(self.special_fields.unknown_fields())?;
            ::std::result::Result::Ok(())
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#ignition/msgs/joint_animation.proto\x12\rignition.msgs\x1a\x18ignitio\
    n/msgs/time.proto\x1a\x1aignition/msgs/header.proto\"\xf5\x01\n\x0eJoint\
    Animation\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.Heade\
    rR\x06header\x12\x1d\n\nmodel_name\x18\x02\x20\x01(\tR\tmodelName\x129\n\
    \x05joint\x18\x03\x20\x03(\x0b2#.ignition.msgs.JointAnimation.JointR\x05\
    joint\x12'\n\x04time\x18\x04\x20\x03(\x0b2\x13.ignition.msgs.TimeR\x04ti\
    me\x1a1\n\x05Joint\x12\x12\n\x04name\x18\x01\x20\x03(\tR\x04name\x12\x14\
    \n\x05angle\x18\x02\x20\x03(\x01R\x05angleB)\n\x11com.ignition.msgsB\x14\
    JointAnimationProtosb\x06proto3\
";
