...
//! Generated file from `ignition/msgs/model_configuration.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.ModelConfiguration)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ModelConfiguration {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.ModelConfiguration.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.ModelConfiguration.time)
    pub time: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:ignition.msgs.ModelConfiguration.joint_names)
    pub joint_names: ::std::vec::Vec<::std::string::String>,
    // @@protoc_insertion_point(field:ignition.msgs.ModelConfiguration.joint_positions)
    pub joint_positions: ::std::vec::Vec<f64>,
    // @@protoc_insertion_point(field:ignition.msgs.ModelConfiguration.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.ModelConfiguration.link_name)
    pub link_name: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.ModelConfiguration.special_fields)
...
impl ::protobuf::Message for ModelConfiguration {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_double_size(4, &self.joint_positions);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_double(4, &self.joint_positions)?;
        if let Some(v) = self.pose.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'ignition/msgs/model_configuration.proto\x12\rignition.msgs\x1a\x18ign\
    ition/msgs/time.proto\x1a\x18ignition/msgs/pose.proto\x1a\x1aignition/ms\
    gs/header.proto\"\xfc\x01\n\x12ModelConfiguration\x12-\n\x06header\x18\
    \x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12'\n\x04time\
    \x18\x02\x20\x01(\x0b2\x13.ignition.msgs.TimeR\x04time\x12\x1f\n\x0bjoin\
    t_names\x18\x03\x20\x03(\tR\njointNames\x12'\n\x0fjoint_positions\x18\
    \x04\x20\x03(\x01R\x0ejointPositions\x12'\n\x04pose\x18\x05\x20\x01(\x0b\
    2\x13.ignition.msgs.PoseR\x04pose\x12\x1b\n\tlink_name\x18\x06\x20\x01(\
    \tR\x08linkNameB-\n\x11com.ignition.msgsB\x18ModelConfigurationProtosb\
    \x06proto3\
";
