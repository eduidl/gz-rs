...
//! Generated file from `ignition/msgs/sim_event.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.SimEvent)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SimEvent {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.SimEvent.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.SimEvent.id)
    pub id: u32,
    // @@protoc_insertion_point(field:ignition.msgs.SimEvent.type)
    pub type_: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.SimEvent.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.SimEvent.world_statistics)
    pub world_statistics: ::protobuf::MessageField<super::world_stats::WorldStatistics>,
    // @@protoc_insertion_point(field:ignition.msgs.SimEvent.data)
    pub data: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.SimEvent.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dignition/msgs/sim_event.proto\x12\rignition.msgs\x1a\x1fignition/m\
    sgs/world_stats.proto\x1a\x1aignition/msgs/header.proto\"\xd0\x01\n\x08S\
    imEvent\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\
    \x06header\x12\x0e\n\x02id\x18\x02\x20\x01(\rR\x02id\x12\x12\n\x04type\
    \x18\x03\x20\x01(\tR\x04type\x12\x12\n\x04name\x18\x04\x20\x01(\tR\x04na\
    me\x12I\n\x10world_statistics\x18\x05\x20\x01(\x0b2\x1e.ignition.msgs.Wo\
    rldStatisticsR\x0fworldStatistics\x12\x12\n\x04data\x18\x06\x20\x01(\tR\
    \x04dataB#\n\x11com.ignition.msgsB\x0eSimEventProtosb\x06proto3\
";
