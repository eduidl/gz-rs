...
//! Generated file from `ignition/msgs/laserscan.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.LaserScan)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LaserScan {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.frame)
    pub frame: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.world_pose)
    pub world_pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.angle_min)
    pub angle_min: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.angle_max)
    pub angle_max: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.angle_step)
    pub angle_step: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.range_min)
    pub range_min: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.range_max)
    pub range_max: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.count)
    pub count: u32,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.vertical_angle_min)
    pub vertical_angle_min: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.vertical_angle_max)
    pub vertical_angle_max: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.vertical_angle_step)
    pub vertical_angle_step: f64,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.vertical_count)
    pub vertical_count: u32,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.ranges)
    pub ranges: ::std::vec::Vec<f64>,
    // @@protoc_insertion_point(field:ignition.msgs.LaserScan.intensities)
    pub intensities: ::std::vec::Vec<f64>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.LaserScan.special_fields)
...
impl ::protobuf::Message for LaserScan {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_double_size(14, &self.ranges);
        my_size += ::protobuf::rt::vec_packed_double_size(15, &self.intensities);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_double(14, &self.ranges)?;
        os.write_repeated_packed_double(15, &self.intensities)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sgs/pose.proto\x1a\x1aignition/msgs/header.proto\"\x9a\x04\n\tLaserScan\
    \x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06hea\
    der\x12\x14\n\x05frame\x18\x02\x20\x01(\tR\x05frame\x122\n\nworld_pose\
    \x18\x03\x20\x01(\x0b2\x13.ignition.msgs.PoseR\tworldPose\x12\x1b\n\tang\
    le_min\x18\x04\x20\x01(\x01R\x08angleMin\x12\x1b\n\tangle_max\x18\x05\
    \x20\x01(\x01R\x08angleMax\x12\x1d\n\nangle_step\x18\x06\x20\x01(\x01R\t\
