...
pub mod shadows {
    ...
    impl ::protobuf::Enum for ShadowType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<ShadowType> {
            match str {
                "STENCIL_ADDITIVE" => ::std::option::Option::Some(ShadowType::STENCIL_ADDITIVE),
                "STENCIL_MODULATIVE" => ::std::option::Option::Some(ShadowType::STENCIL_MODULATIVE),
                "TEXTURE_ADDITIVE" => ::std::option::Option::Some(ShadowType::TEXTURE_ADDITIVE),
                "TEXTURE_MODULATIVE" => ::std::option::Option::Some(ShadowType::TEXTURE_MODULATIVE),
                _ => ::std::option::Option::None
            }
        }
