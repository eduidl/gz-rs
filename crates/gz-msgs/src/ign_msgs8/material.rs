...
//! Generated file from `ignition/msgs/material.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.Material)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Material {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.Material.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.script)
    pub script: ::protobuf::MessageField<material::Script>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.shader_type)
    pub shader_type: ::protobuf::EnumOrUnknown<material::ShaderType>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.normal_map)
    pub normal_map: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.Material.ambient)
    pub ambient: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.diffuse)
    pub diffuse: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.specular)
    pub specular: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.emissive)
    pub emissive: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.lighting)
    pub lighting: bool,
    // @@protoc_insertion_point(field:ignition.msgs.Material.pbr)
    pub pbr: ::protobuf::MessageField<material::PBR>,
    // @@protoc_insertion_point(field:ignition.msgs.Material.render_order)
    pub render_order: f64,
    // @@protoc_insertion_point(field:ignition.msgs.Material.double_sided)
    pub double_sided: bool,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.Material.special_fields)
...
pub mod material {
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.Material.Script)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Script {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.Material.Script.uri)
        pub uri: ::std::vec::Vec<::std::string::String>,
        // @@protoc_insertion_point(field:ignition.msgs.Material.Script.name)
        pub name: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.Material.Script.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    #[derive(::gz_msgs_common::IgnMessage)]
    // @@protoc_insertion_point(message:ignition.msgs.Material.PBR)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct PBR {
        // message fields
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.type)
        pub type_: ::protobuf::EnumOrUnknown<pbr::WorkflowType>,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.albedo_map)
        pub albedo_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.normal_map)
        pub normal_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.metalness)
        pub metalness: f64,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.metalness_map)
        pub metalness_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.roughness)
        pub roughness: f64,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.roughness_map)
        pub roughness_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.glossiness)
        pub glossiness: f64,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.glossiness_map)
        pub glossiness_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.specular_map)
        pub specular_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.environment_map)
        pub environment_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.ambient_occlusion_map)
        pub ambient_occlusion_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.emissive_map)
        pub emissive_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.light_map)
        pub light_map: ::std::string::String,
        // @@protoc_insertion_point(field:ignition.msgs.Material.PBR.light_map_texcoord_set)
        pub light_map_texcoord_set: u32,
        // special fields
        // @@protoc_insertion_point(special_field:ignition.msgs.Material.PBR.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    pub mod pbr {
        ...
        // @@protoc_insertion_point(enum:ignition.msgs.Material.PBR.WorkflowType)
        pub enum WorkflowType {
            // @@protoc_insertion_point(enum_value:ignition.msgs.Material.PBR.WorkflowType.NONE)
            NONE = 0,
            // @@protoc_insertion_point(enum_value:ignition.msgs.Material.PBR.WorkflowType.METAL)
            METAL = 1,
            // @@protoc_insertion_point(enum_value:ignition.msgs.Material.PBR.WorkflowType.SPECULAR)
            SPECULAR = 2,
        }
        ...
        impl ::protobuf::Enum for WorkflowType {
            ...
            fn from_str(str: &str) -> ::std::option::Option<WorkflowType> {
                match str {
                    "NONE" => ::std::option::Option::Some(WorkflowType::NONE),
                    "METAL" => ::std::option::Option::Some(WorkflowType::METAL),
                    "SPECULAR" => ::std::option::Option::Some(WorkflowType::SPECULAR),
                    _ => ::std::option::Option::None
                }
            }
    ...
    #[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
    // @@protoc_insertion_point(enum:ignition.msgs.Material.ShaderType)
    pub enum ShaderType {
        // @@protoc_insertion_point(enum_value:ignition.msgs.Material.ShaderType.VERTEX)
        VERTEX = 0,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Material.ShaderType.PIXEL)
        PIXEL = 1,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Material.ShaderType.NORMAL_MAP_OBJECT_SPACE)
        NORMAL_MAP_OBJECT_SPACE = 2,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Material.ShaderType.NORMAL_MAP_TANGENT_SPACE)
    ...
    impl ::protobuf::Enum for ShaderType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<ShaderType> {
            match str {
                "VERTEX" => ::std::option::Option::Some(ShaderType::VERTEX),
                "PIXEL" => ::std::option::Option::Some(ShaderType::PIXEL),
                "NORMAL_MAP_OBJECT_SPACE" => ::std::option::Option::Some(ShaderType::NORMAL_MAP_OBJECT_SPACE),
                "NORMAL_MAP_TANGENT_SPACE" => ::std::option::Option::Some(ShaderType::NORMAL_MAP_TANGENT_SPACE),
                _ => ::std::option::Option::None
            }
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cignition/msgs/material.proto\x12\rignition.msgs\x1a\x19ignition/ms\
    gs/color.proto\x1a\x1aignition/msgs/header.proto\"\xb3\n\n\x08Material\
    \x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06hea\
    der\x126\n\x06script\x18\x02\x20\x01(\x0b2\x1e.ignition.msgs.Material.Sc\
    riptR\x06script\x12C\n\x0bshader_type\x18\x03\x20\x01(\x0e2\".ignition.m\
    sgs.Material.ShaderTypeR\nshaderType\x12\x1d\n\nnormal_map\x18\x04\x20\
    \x01(\tR\tnormalMap\x12.\n\x07ambient\x18\x05\x20\x01(\x0b2\x14.ignition\
    .msgs.ColorR\x07ambient\x12.\n\x07diffuse\x18\x06\x20\x01(\x0b2\x14.igni\
    tion.msgs.ColorR\x07diffuse\x120\n\x08specular\x18\x07\x20\x01(\x0b2\x14\
    .ignition.msgs.ColorR\x08specular\x120\n\x08emissive\x18\x08\x20\x01(\
    \x0b2\x14.ignition.msgs.ColorR\x08emissive\x12\x1a\n\x08lighting\x18\t\
    \x20\x01(\x08R\x08lighting\x12-\n\x03pbr\x18\n\x20\x01(\x0b2\x1b.ignitio\
    n.msgs.Material.PBRR\x03pbr\x12!\n\x0crender_order\x18\x0b\x20\x01(\x01R\
    \x0brenderOrder\x12!\n\x0cdouble_sided\x18\x0c\x20\x01(\x08R\x0bdoubleSi\
    ded\x1a.\n\x06Script\x12\x10\n\x03uri\x18\x01\x20\x03(\tR\x03uri\x12\x12\
    \n\x04name\x18\x02\x20\x01(\tR\x04name\x1a\xf6\x04\n\x03PBR\x12<\n\x04ty\
    pe\x18\x01\x20\x01(\x0e2(.ignition.msgs.Material.PBR.WorkflowTypeR\x04ty\
    pe\x12\x1d\n\nalbedo_map\x18\x02\x20\x01(\tR\talbedoMap\x12\x1d\n\nnorma\
    l_map\x18\x03\x20\x01(\tR\tnormalMap\x12\x1c\n\tmetalness\x18\x04\x20\
    \x01(\x01R\tmetalness\x12#\n\rmetalness_map\x18\x05\x20\x01(\tR\x0cmetal\
    nessMap\x12\x1c\n\troughness\x18\x06\x20\x01(\x01R\troughness\x12#\n\rro\
    ughness_map\x18\x07\x20\x01(\tR\x0croughnessMap\x12\x1e\n\nglossiness\
    \x18\x08\x20\x01(\x01R\nglossiness\x12%\n\x0eglossiness_map\x18\t\x20\
    \x01(\tR\rglossinessMap\x12!\n\x0cspecular_map\x18\n\x20\x01(\tR\x0bspec\
    ularMap\x12'\n\x0fenvironment_map\x18\x0b\x20\x01(\tR\x0eenvironmentMap\
    \x122\n\x15ambient_occlusion_map\x18\x0c\x20\x01(\tR\x13ambientOcclusion\
    Map\x12!\n\x0cemissive_map\x18\r\x20\x01(\tR\x0bemissiveMap\x12\x1b\n\tl\
    ight_map\x18\x0e\x20\x01(\tR\x08lightMap\x123\n\x16light_map_texcoord_se\
    t\x18\x0f\x20\x01(\rR\x13lightMapTexcoordSet\"1\n\x0cWorkflowType\x12\
    \x08\n\x04NONE\x10\0\x12\t\n\x05METAL\x10\x01\x12\x0c\n\x08SPECULAR\x10\
    \x02\"^\n\nShaderType\x12\n\n\x06VERTEX\x10\0\x12\t\n\x05PIXEL\x10\x01\
    \x12\x1b\n\x17NORMAL_MAP_OBJECT_SPACE\x10\x02\x12\x1c\n\x18NORMAL_MAP_TA\
    NGENT_SPACE\x10\x03B#\n\x11com.ignition.msgsB\x0eMaterialProtosb\x06prot\
    o3\
";
