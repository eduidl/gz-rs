...
//! Generated file from `ignition/msgs/world_stats.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.WorldStatistics)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct WorldStatistics {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.sim_time)
    pub sim_time: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.pause_time)
    pub pause_time: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.real_time)
    pub real_time: ::protobuf::MessageField<super::time::Time>,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.paused)
    pub paused: bool,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.iterations)
    pub iterations: u64,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.model_count)
    pub model_count: i32,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.log_playback_stats)
    pub log_playback_stats: ::protobuf::MessageField<super::log_playback_stats::LogPlaybackStatistics>,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.real_time_factor)
    pub real_time_factor: f64,
    // @@protoc_insertion_point(field:ignition.msgs.WorldStatistics.step_size)
    pub step_size: ::protobuf::MessageField<super::time::Time>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.WorldStatistics.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fignition/msgs/world_stats.proto\x12\rignition.msgs\x1a&ignition/ms\
    gs/log_playback_stats.proto\x1a\x18ignition/msgs/time.proto\x1a\x1aignit\
    ion/msgs/header.proto\"\xdf\x03\n\x0fWorldStatistics\x12-\n\x06header\
    \x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12.\n\x08sim\
    _time\x18\x02\x20\x01(\x0b2\x13.ignition.msgs.TimeR\x07simTime\x122\n\np\
    ause_time\x18\x03\x20\x01(\x0b2\x13.ignition.msgs.TimeR\tpauseTime\x120\
    \n\treal_time\x18\x04\x20\x01(\x0b2\x13.ignition.msgs.TimeR\x08realTime\
    \x12\x16\n\x06paused\x18\x05\x20\x01(\x08R\x06paused\x12\x1e\n\niteratio\
    ns\x18\x06\x20\x01(\x04R\niterations\x12\x1f\n\x0bmodel_count\x18\x07\
    \x20\x01(\x05R\nmodelCount\x12R\n\x12log_playback_stats\x18\x08\x20\x01(\
    \x0b2$.ignition.msgs.LogPlaybackStatisticsR\x10logPlaybackStats\x12(\n\
    \x10real_time_factor\x18\t\x20\x01(\x01R\x0erealTimeFactor\x120\n\tstep_\
    size\x18\n\x20\x01(\x0b2\x13.ignition.msgs.TimeR\x08stepSizeB%\n\x11com.\
    ignition.msgsB\x10WorldStatsProtosb\x06proto3\
";
