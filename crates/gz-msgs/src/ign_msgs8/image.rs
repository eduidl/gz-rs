...
//! Generated file from `ignition/msgs/image.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.Image)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Image {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.Image.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.Image.width)
    pub width: u32,
    // @@protoc_insertion_point(field:ignition.msgs.Image.height)
    pub height: u32,
    // @@protoc_insertion_point(field:ignition.msgs.Image.step)
    pub step: u32,
    // @@protoc_insertion_point(field:ignition.msgs.Image.data)
    pub data: ::std::vec::Vec<u8>,
    // @@protoc_insertion_point(field:ignition.msgs.Image.pixel_format_type)
    pub pixel_format_type: ::protobuf::EnumOrUnknown<PixelFormatType>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.Image.special_fields)
...
// @@protoc_insertion_point(enum:ignition.msgs.PixelFormatType)
pub enum PixelFormatType {
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.UNKNOWN_PIXEL_FORMAT)
    UNKNOWN_PIXEL_FORMAT = 0,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.L_INT8)
    L_INT8 = 1,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.L_INT16)
    L_INT16 = 2,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.RGB_INT8)
    RGB_INT8 = 3,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.RGBA_INT8)
    RGBA_INT8 = 4,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BGRA_INT8)
    BGRA_INT8 = 5,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.RGB_INT16)
    RGB_INT16 = 6,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.RGB_INT32)
    RGB_INT32 = 7,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BGR_INT8)
    BGR_INT8 = 8,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BGR_INT16)
    BGR_INT16 = 9,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BGR_INT32)
    BGR_INT32 = 10,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.R_FLOAT16)
    R_FLOAT16 = 11,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.RGB_FLOAT16)
    RGB_FLOAT16 = 12,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.R_FLOAT32)
    R_FLOAT32 = 13,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.RGB_FLOAT32)
    RGB_FLOAT32 = 14,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BAYER_RGGB8)
    BAYER_RGGB8 = 15,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BAYER_BGGR8)
    BAYER_BGGR8 = 16,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BAYER_GBRG8)
    BAYER_GBRG8 = 17,
    // @@protoc_insertion_point(enum_value:ignition.msgs.PixelFormatType.BAYER_GRBG8)
    BAYER_GRBG8 = 18,
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19ignition/msgs/image.proto\x12\rignition.msgs\x1a\x1aignition/msgs/\
    header.proto\"\xd8\x01\n\x05Image\x12-\n\x06header\x18\x01\x20\x01(\x0b2\
    \x15.ignition.msgs.HeaderR\x06header\x12\x14\n\x05width\x18\x02\x20\x01(\
    \rR\x05width\x12\x16\n\x06height\x18\x03\x20\x01(\rR\x06height\x12\x12\n\
    \x04step\x18\x04\x20\x01(\rR\x04step\x12\x12\n\x04data\x18\x05\x20\x01(\
    \x0cR\x04data\x12J\n\x11pixel_format_type\x18\x06\x20\x01(\x0e2\x1e.igni\
    tion.msgs.PixelFormatTypeR\x0fpixelFormatType*\xbe\x02\n\x0fPixelFormatT\
    ype\x12\x18\n\x14UNKNOWN_PIXEL_FORMAT\x10\0\x12\n\n\x06L_INT8\x10\x01\
    ...
    RGB_FLOAT16\x10\x0c\x12\r\n\tR_FLOAT32\x10\r\x12\x0f\n\x0bRGB_FLOAT32\
    \x10\x0e\x12\x0f\n\x0bBAYER_RGGB8\x10\x0f\x12\x0f\n\x0bBAYER_BGGR8\x10\
    \x10\x12\x0f\n\x0bBAYER_GBRG8\x10\x11\x12\x0f\n\x0bBAYER_GRBG8\x10\x12B\
    \x20\n\x11com.ignition.msgsB\x0bImageProtosb\x06proto3\
";
