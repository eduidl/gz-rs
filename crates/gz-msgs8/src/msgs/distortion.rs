...
//! Generated file from `ignition/msgs/distortion.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.Distortion)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Distortion {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.center)
    pub center: ::protobuf::MessageField<super::vector2d::Vector2d>,
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.k1)
    pub k1: f64,
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.k2)
    pub k2: f64,
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.k3)
    pub k3: f64,
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.p1)
    pub p1: f64,
    // @@protoc_insertion_point(field:ignition.msgs.Distortion.p2)
    pub p2: f64,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.Distortion.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eignition/msgs/distortion.proto\x12\rignition.msgs\x1a\x1cignition/\
    msgs/vector2d.proto\x1a\x1aignition/msgs/header.proto\"\xbc\x01\n\nDisto\
    rtion\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\
    \x06header\x12/\n\x06center\x18\x02\x20\x01(\x0b2\x17.ignition.msgs.Vect\
    or2dR\x06center\x12\x0e\n\x02k1\x18\x03\x20\x01(\x01R\x02k1\x12\x0e\n\
    \x02k2\x18\x04\x20\x01(\x01R\x02k2\x12\x0e\n\x02k3\x18\x05\x20\x01(\x01R\
    \x02k3\x12\x0e\n\x02p1\x18\x06\x20\x01(\x01R\x02p1\x12\x0e\n\x02p2\x18\
    \x07\x20\x01(\x01R\x02p2B%\n\x11com.ignition.msgsB\x10DistortionProtosb\
    \x06proto3\
";
