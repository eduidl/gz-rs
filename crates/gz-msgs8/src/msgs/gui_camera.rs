...
//! Generated file from `ignition/msgs/gui_camera.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.GUICamera)
pub struct GUICamera {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.GUICamera.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.GUICamera.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.GUICamera.view_controller)
    pub view_controller: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.GUICamera.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.GUICamera.track)
    pub track: ::protobuf::MessageField<super::track_visual::TrackVisual>,
    // @@protoc_insertion_point(field:ignition.msgs.GUICamera.projection_type)
    pub projection_type: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.GUICamera.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eignition/msgs/gui_camera.proto\x12\rignition.msgs\x1a\x18ignition/\
    msgs/pose.proto\x1a\x20ignition/msgs/track_visual.proto\x1a\x1aignition/\
    msgs/header.proto\"\xfb\x01\n\tGUICamera\x12-\n\x06header\x18\x01\x20\
    \x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x12\n\x04name\x18\x02\
    \x20\x01(\tR\x04name\x12'\n\x0fview_controller\x18\x03\x20\x01(\tR\x0evi\
    ewController\x12'\n\x04pose\x18\x04\x20\x01(\x0b2\x13.ignition.msgs.Pose\
    R\x04pose\x120\n\x05track\x18\x05\x20\x01(\x0b2\x1a.ignition.msgs.TrackV\
    isualR\x05track\x12'\n\x0fprojection_type\x18\x06\x20\x01(\tR\x0eproject\
    ionTypeB$\n\x11com.ignition.msgsB\x0fGUICameraProtosb\x06proto3\
";
