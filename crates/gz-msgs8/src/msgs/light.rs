...
//! Generated file from `ignition/msgs/light.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.Light)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Light {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.Light.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.Light.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.Light.type)
    pub type_: ::protobuf::EnumOrUnknown<light::LightType>,
    // @@protoc_insertion_point(field:ignition.msgs.Light.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.Light.diffuse)
    pub diffuse: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Light.specular)
    pub specular: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Light.attenuation_constant)
    pub attenuation_constant: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.attenuation_linear)
    pub attenuation_linear: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.attenuation_quadratic)
    pub attenuation_quadratic: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.direction)
    pub direction: ::protobuf::MessageField<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:ignition.msgs.Light.range)
    pub range: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.cast_shadows)
    pub cast_shadows: bool,
    // @@protoc_insertion_point(field:ignition.msgs.Light.spot_inner_angle)
    pub spot_inner_angle: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.spot_outer_angle)
    pub spot_outer_angle: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.spot_falloff)
    pub spot_falloff: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.id)
    pub id: u32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.parent_id)
    pub parent_id: u32,
    // @@protoc_insertion_point(field:ignition.msgs.Light.intensity)
    pub intensity: f32,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.Light.special_fields)
...
pub mod light {
    ...
    // @@protoc_insertion_point(enum:ignition.msgs.Light.LightType)
    pub enum LightType {
        // @@protoc_insertion_point(enum_value:ignition.msgs.Light.LightType.POINT)
        POINT = 0,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Light.LightType.SPOT)
        SPOT = 1,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Light.LightType.DIRECTIONAL)
        DIRECTIONAL = 2,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    header.proto\x1a\x18ignition/msgs/pose.proto\x1a\x1cignition/msgs/vector\
    3d.proto\x1a\x19ignition/msgs/color.proto\"\x85\x06\n\x05Light\x12-\n\
    \x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\
    \x12\n\x04name\x18\x02\x20\x01(\tR\x04name\x122\n\x04type\x18\x03\x20\
    \x01(\x0e2\x1e.ignition.msgs.Light.LightTypeR\x04type\x12'\n\x04pose\x18\
    \x04\x20\x01(\x0b2\x13.ignition.msgs.PoseR\x04pose\x12.\n\x07diffuse\x18\
    \x05\x20\x01(\x0b2\x14.ignition.msgs.ColorR\x07diffuse\x120\n\x08specula\
    r\x18\x06\x20\x01(\x0b2\x14.ignition.msgs.ColorR\x08specular\x121\n\x14a\
    ttenuation_constant\x18\x07\x20\x01(\x02R\x13attenuationConstant\x12-\n\
    \x12attenuation_linear\x18\x08\x20\x01(\x02R\x11attenuationLinear\x123\n\
    \x15attenuation_quadratic\x18\t\x20\x01(\x02R\x14attenuationQuadratic\
    \x125\n\tdirection\x18\n\x20\x01(\x0b2\x17.ignition.msgs.Vector3dR\tdire\
    ction\x12\x14\n\x05range\x18\x0b\x20\x01(\x02R\x05range\x12!\n\x0ccast_s\
    hadows\x18\x0c\x20\x01(\x08R\x0bcastShadows\x12(\n\x10spot_inner_angle\
    \x18\r\x20\x01(\x02R\x0espotInnerAngle\x12(\n\x10spot_outer_angle\x18\
    \x0e\x20\x01(\x02R\x0espotOuterAngle\x12!\n\x0cspot_falloff\x18\x0f\x20\
    \x01(\x02R\x0bspotFalloff\x12\x0e\n\x02id\x18\x10\x20\x01(\rR\x02id\x12\
    \x1b\n\tparent_id\x18\x11\x20\x01(\rR\x08parentId\x12\x1c\n\tintensity\
    \x18\x12\x20\x01(\x02R\tintensity\"1\n\tLightType\x12\t\n\x05POINT\x10\0\
    \x12\x08\n\x04SPOT\x10\x01\x12\x0f\n\x0bDIRECTIONAL\x10\x02B\x20\n\x11co\
    m.ignition.msgsB\x0bLightProtosb\x06proto3\
";
