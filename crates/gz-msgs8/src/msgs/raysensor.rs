...
//! Generated file from `ignition/msgs/raysensor.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.RaySensor)
pub struct RaySensor {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.display_scan)
    pub display_scan: bool,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.horizontal_samples)
    pub horizontal_samples: i32,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.horizontal_resolution)
    pub horizontal_resolution: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.horizontal_min_angle)
    pub horizontal_min_angle: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.horizontal_max_angle)
    pub horizontal_max_angle: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.vertical_samples)
    pub vertical_samples: i32,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.vertical_resolution)
    pub vertical_resolution: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.vertical_min_angle)
    pub vertical_min_angle: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.vertical_max_angle)
    pub vertical_max_angle: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.range_min)
    pub range_min: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.range_max)
    pub range_max: f64,
    // @@protoc_insertion_point(field:ignition.msgs.RaySensor.range_resolution)
    pub range_resolution: f64,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.RaySensor.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dignition/msgs/raysensor.proto\x12\rignition.msgs\x1a\x1aignition/m\
    sgs/header.proto\"\xc2\x04\n\tRaySensor\x12-\n\x06header\x18\x01\x20\x01\
    (\x0b2\x15.ignition.msgs.HeaderR\x06header\x12!\n\x0cdisplay_scan\x18\
    \x02\x20\x01(\x08R\x0bdisplayScan\x12-\n\x12horizontal_samples\x18\x03\
    \x20\x01(\x05R\x11horizontalSamples\x123\n\x15horizontal_resolution\x18\
    \x04\x20\x01(\x01R\x14horizontalResolution\x120\n\x14horizontal_min_angl\
    e\x18\x05\x20\x01(\x01R\x12horizontalMinAngle\x120\n\x14horizontal_max_a\
    ngle\x18\x06\x20\x01(\x01R\x12horizontalMaxAngle\x12)\n\x10vertical_samp\
    les\x18\x07\x20\x01(\x05R\x0fverticalSamples\x12/\n\x13vertical_resoluti\
    on\x18\x08\x20\x01(\x01R\x12verticalResolution\x12,\n\x12vertical_min_an\
    gle\x18\t\x20\x01(\x01R\x10verticalMinAngle\x12,\n\x12vertical_max_angle\
    \x18\n\x20\x01(\x01R\x10verticalMaxAngle\x12\x1b\n\trange_min\x18\x0b\
    \x20\x01(\x01R\x08rangeMin\x12\x1b\n\trange_max\x18\x0c\x20\x01(\x01R\
    \x08rangeMax\x12)\n\x10range_resolution\x18\r\x20\x01(\x01R\x0frangeReso\
    lutionB$\n\x11com.ignition.msgsB\x0fRaySensorProtosb\x06proto3\
";
