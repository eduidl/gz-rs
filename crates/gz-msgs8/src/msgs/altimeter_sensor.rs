...
//! Generated file from `ignition/msgs/altimeter_sensor.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.AltimeterSensor)
pub struct AltimeterSensor {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.AltimeterSensor.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.AltimeterSensor.vertical_position_noise)
    pub vertical_position_noise: ::protobuf::MessageField<super::sensor_noise::SensorNoise>,
    // @@protoc_insertion_point(field:ignition.msgs.AltimeterSensor.vertical_velocity_noise)
    pub vertical_velocity_noise: ::protobuf::MessageField<super::sensor_noise::SensorNoise>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.AltimeterSensor.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$ignition/msgs/altimeter_sensor.proto\x12\rignition.msgs\x1a\x1aigniti\
    on/msgs/header.proto\x1a\x20ignition/msgs/sensor_noise.proto\"\xe8\x01\n\
    \x0fAltimeterSensor\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ignition.\
    msgs.HeaderR\x06header\x12R\n\x17vertical_position_noise\x18\x02\x20\x01\
    (\x0b2\x1a.ignition.msgs.SensorNoiseR\x15verticalPositionNoise\x12R\n\
    \x17vertical_velocity_noise\x18\x03\x20\x01(\x0b2\x1a.ignition.msgs.Sens\
    orNoiseR\x15verticalVelocityNoiseB*\n\x11com.ignition.msgsB\x15Altimeter\
    SensorProtosb\x06proto3\
";
