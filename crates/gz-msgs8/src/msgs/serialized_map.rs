...
//! Generated file from `ignition/msgs/serialized_map.proto`
...
pub struct SerializedEntityMap {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.SerializedEntityMap.id)
    pub id: u64,
    // @@protoc_insertion_point(field:ignition.msgs.SerializedEntityMap.components)
    pub components: ::std::collections::HashMap<i64, super::serialized::SerializedComponent>,
    // @@protoc_insertion_point(field:ignition.msgs.SerializedEntityMap.remove)
    pub remove: bool,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.SerializedEntityMap.special_fields)
...
pub struct SerializedStateMap {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.SerializedStateMap.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.SerializedStateMap.entities)
    pub entities: ::std::collections::HashMap<u64, SerializedEntityMap>,
    // @@protoc_insertion_point(field:ignition.msgs.SerializedStateMap.has_one_time_component_changes)
    pub has_one_time_component_changes: bool,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.SerializedStateMap.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
pub struct SerializedStepMap {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.SerializedStepMap.stats)
    pub stats: ::protobuf::MessageField<super::world_stats::WorldStatistics>,
    // @@protoc_insertion_point(field:ignition.msgs.SerializedStepMap.state)
    pub state: ::protobuf::MessageField<SerializedStateMap>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.SerializedStepMap.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"ignition/msgs/serialized_map.proto\x12\rignition.msgs\x1a\x1aignitio\
    n/msgs/header.proto\x1a\x1fignition/msgs/world_stats.proto\x1a\x1eigniti\
    on/msgs/serialized.proto\"\xf4\x01\n\x13SerializedEntityMap\x12\x0e\n\
    \x02id\x18\x01\x20\x01(\x04R\x02id\x12R\n\ncomponents\x18\x02\x20\x03(\
    \x0b22.ignition.msgs.SerializedEntityMap.ComponentsEntryR\ncomponents\
    \x12\x16\n\x06remove\x18\x03\x20\x01(\x08R\x06remove\x1aa\n\x0fComponent\
    sEntry\x12\x10\n\x03key\x18\x01\x20\x01(\x03R\x03key\x128\n\x05value\x18\
    \x02\x20\x01(\x0b2\".ignition.msgs.SerializedComponentR\x05value:\x028\
    \x01\"\xb5\x02\n\x12SerializedStateMap\x12-\n\x06header\x18\x01\x20\x01(\
    \x0b2\x15.ignition.msgs.HeaderR\x06header\x12K\n\x08entities\x18\x02\x20\
    \x03(\x0b2/.ignition.msgs.SerializedStateMap.EntitiesEntryR\x08entities\
    \x12B\n\x1ehas_one_time_component_changes\x18\x03\x20\x01(\x08R\x1ahasOn\
    eTimeComponentChanges\x1a_\n\rEntitiesEntry\x12\x10\n\x03key\x18\x01\x20\
    \x01(\x04R\x03key\x128\n\x05value\x18\x02\x20\x01(\x0b2\".ignition.msgs.\
    SerializedEntityMapR\x05value:\x028\x01\"\x82\x01\n\x11SerializedStepMap\
    \x124\n\x05stats\x18\x01\x20\x01(\x0b2\x1e.ignition.msgs.WorldStatistics\
    R\x05stats\x127\n\x05state\x18\x02\x20\x01(\x0b2!.ignition.msgs.Serializ\
    edStateMapR\x05stateB\x13\n\x11com.ignition.msgsb\x06proto3\
";
