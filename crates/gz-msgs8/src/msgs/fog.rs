...
//! Generated file from `ignition/msgs/fog.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.Fog)
pub struct Fog {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.Fog.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.Fog.type)
    pub type_: ::protobuf::EnumOrUnknown<fog::FogType>,
    // @@protoc_insertion_point(field:ignition.msgs.Fog.color)
    pub color: ::protobuf::MessageField<super::color::Color>,
    // @@protoc_insertion_point(field:ignition.msgs.Fog.density)
    pub density: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Fog.start)
    pub start: f32,
    // @@protoc_insertion_point(field:ignition.msgs.Fog.end)
    pub end: f32,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.Fog.special_fields)
...
pub mod fog {
    ...
    // @@protoc_insertion_point(enum:ignition.msgs.Fog.FogType)
    pub enum FogType {
        // @@protoc_insertion_point(enum_value:ignition.msgs.Fog.FogType.NONE)
        NONE = 0,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Fog.FogType.LINEAR)
        LINEAR = 1,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Fog.FogType.EXPONENTIAL)
        EXPONENTIAL = 2,
        // @@protoc_insertion_point(enum_value:ignition.msgs.Fog.FogType.EXPONENTIAL2)
        EXPONENTIAL2 = 3,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17ignition/msgs/fog.proto\x12\rignition.msgs\x1a\x19ignition/msgs/co\
    lor.proto\x1a\x1aignition/msgs/header.proto\"\x96\x02\n\x03Fog\x12-\n\
    \x06header\x18\x01\x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\
    .\n\x04type\x18\x02\x20\x01(\x0e2\x1a.ignition.msgs.Fog.FogTypeR\x04type\
    \x12*\n\x05color\x18\x03\x20\x01(\x0b2\x14.ignition.msgs.ColorR\x05color\
    \x12\x18\n\x07density\x18\x04\x20\x01(\x02R\x07density\x12\x14\n\x05star\
    t\x18\x05\x20\x01(\x02R\x05start\x12\x10\n\x03end\x18\x06\x20\x01(\x02R\
    \x03end\"B\n\x07FogType\x12\x08\n\x04NONE\x10\0\x12\n\n\x06LINEAR\x10\
    \x01\x12\x0f\n\x0bEXPONENTIAL\x10\x02\x12\x10\n\x0cEXPONENTIAL2\x10\x03B\
    \x1e\n\x11com.ignition.msgsB\tFogProtosb\x06proto3\
";
