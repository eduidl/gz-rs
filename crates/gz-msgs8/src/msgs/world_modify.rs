...
//! Generated file from `ignition/msgs/world_modify.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.WorldModify)
pub struct WorldModify {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.WorldModify.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.WorldModify.world_name)
    pub world_name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.WorldModify.remove)
    pub remove: bool,
    // @@protoc_insertion_point(field:ignition.msgs.WorldModify.create)
    pub create: bool,
    // @@protoc_insertion_point(field:ignition.msgs.WorldModify.cloned)
    pub cloned: bool,
    // @@protoc_insertion_point(field:ignition.msgs.WorldModify.cloned_uri)
    pub cloned_uri: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.WorldModify.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20ignition/msgs/world_modify.proto\x12\rignition.msgs\x1a\x1aignitio\
    n/msgs/header.proto\"\xc2\x01\n\x0bWorldModify\x12-\n\x06header\x18\x01\
    \x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x1d\n\nworld_name\
    \x18\x02\x20\x01(\tR\tworldName\x12\x16\n\x06remove\x18\x03\x20\x01(\x08\
    R\x06remove\x12\x16\n\x06create\x18\x04\x20\x01(\x08R\x06create\x12\x16\
    \n\x06cloned\x18\x05\x20\x01(\x08R\x06cloned\x12\x1d\n\ncloned_uri\x18\
    \x06\x20\x01(\tR\tclonedUriB&\n\x11com.ignition.msgsB\x11WorldModifyProt\
    osb\x06proto3\
";
