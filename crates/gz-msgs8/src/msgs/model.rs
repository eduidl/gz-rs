...
//! Generated file from `ignition/msgs/model.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.Model)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Model {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.Model.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.Model.id)
    pub id: u32,
    // @@protoc_insertion_point(field:ignition.msgs.Model.is_static)
    pub is_static: bool,
    // @@protoc_insertion_point(field:ignition.msgs.Model.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.joint)
    pub joint: ::std::vec::Vec<super::joint::Joint>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.link)
    pub link: ::std::vec::Vec<super::link::Link>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.deleted)
    pub deleted: bool,
    // @@protoc_insertion_point(field:ignition.msgs.Model.visual)
    pub visual: ::std::vec::Vec<super::visual::Visual>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.scale)
    pub scale: ::protobuf::MessageField<super::vector3d::Vector3d>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.self_collide)
    pub self_collide: bool,
    // @@protoc_insertion_point(field:ignition.msgs.Model.model)
    pub model: ::std::vec::Vec<Model>,
    // @@protoc_insertion_point(field:ignition.msgs.Model.bounding_box)
    pub bounding_box: ::protobuf::MessageField<super::axis_aligned_box::AxisAlignedBox>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.Model.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19ignition/msgs/model.proto\x12\rignition.msgs\x1a$ignition/msgs/axi\
    s_aligned_box.proto\x1a\x19ignition/msgs/joint.proto\x1a\x18ignition/msg\
    s/link.proto\x1a\x18ignition/msgs/pose.proto\x1a\x1aignition/msgs/visual\
    .proto\x1a\x1cignition/msgs/vector3d.proto\x1a\x1aignition/msgs/header.p\
    roto\"\xfe\x03\n\x05Model\x12-\n\x06header\x18\x01\x20\x01(\x0b2\x15.ign\
    ition.msgs.HeaderR\x06header\x12\x12\n\x04name\x18\x02\x20\x01(\tR\x04na\
    me\x12\x0e\n\x02id\x18\x03\x20\x01(\rR\x02id\x12\x1b\n\tis_static\x18\
    \x04\x20\x01(\x08R\x08isStatic\x12'\n\x04pose\x18\x05\x20\x01(\x0b2\x13.\
    ignition.msgs.PoseR\x04pose\x12*\n\x05joint\x18\x06\x20\x03(\x0b2\x14.ig\
    nition.msgs.JointR\x05joint\x12'\n\x04link\x18\x07\x20\x03(\x0b2\x13.ign\
    ition.msgs.LinkR\x04link\x12\x18\n\x07deleted\x18\x08\x20\x01(\x08R\x07d\
    eleted\x12-\n\x06visual\x18\t\x20\x03(\x0b2\x15.ignition.msgs.VisualR\
    \x06visual\x12-\n\x05scale\x18\n\x20\x01(\x0b2\x17.ignition.msgs.Vector3\
    dR\x05scale\x12!\n\x0cself_collide\x18\x0b\x20\x01(\x08R\x0bselfCollide\
    \x12*\n\x05model\x18\x0c\x20\x03(\x0b2\x14.ignition.msgs.ModelR\x05model\
    \x12@\n\x0cbounding_box\x18\r\x20\x01(\x0b2\x1d.ignition.msgs.AxisAligne\
    dBoxR\x0bboundingBoxB\x20\n\x11com.ignition.msgsB\x0bModelProtosb\x06pro\
    to3\
";
