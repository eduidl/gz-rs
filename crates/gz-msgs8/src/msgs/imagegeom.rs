...
//! Generated file from `ignition/msgs/imagegeom.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.ImageGeom)
pub struct ImageGeom {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.ImageGeom.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.ImageGeom.uri)
    pub uri: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.ImageGeom.scale)
    pub scale: f64,
    // @@protoc_insertion_point(field:ignition.msgs.ImageGeom.threshold)
    pub threshold: i32,
    // @@protoc_insertion_point(field:ignition.msgs.ImageGeom.height)
    pub height: f64,
    // @@protoc_insertion_point(field:ignition.msgs.ImageGeom.granularity)
    pub granularity: i32,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.ImageGeom.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dignition/msgs/imagegeom.proto\x12\rignition.msgs\x1a\x1aignition/m\
    sgs/header.proto\"\xba\x01\n\tImageGeom\x12-\n\x06header\x18\x01\x20\x01\
    (\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x10\n\x03uri\x18\x02\x20\
    \x01(\tR\x03uri\x12\x14\n\x05scale\x18\x03\x20\x01(\x01R\x05scale\x12\
    \x1c\n\tthreshold\x18\x04\x20\x01(\x05R\tthreshold\x12\x16\n\x06height\
    \x18\x05\x20\x01(\x01R\x06height\x12\x20\n\x0bgranularity\x18\x06\x20\
    \x01(\x05R\x0bgranularityB$\n\x11com.ignition.msgsB\x0fImageGeomProtosb\
    \x06proto3\
";
