...
//! Generated file from `ignition/msgs/entity_factory.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.EntityFactory)
pub struct EntityFactory {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.EntityFactory.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.EntityFactory.pose)
    pub pose: ::protobuf::MessageField<super::pose::Pose>,
    // @@protoc_insertion_point(field:ignition.msgs.EntityFactory.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.EntityFactory.allow_renaming)
    pub allow_renaming: bool,
    // @@protoc_insertion_point(field:ignition.msgs.EntityFactory.relative_to)
    pub relative_to: ::std::string::String,
    // @@protoc_insertion_point(field:ignition.msgs.EntityFactory.spherical_coordinates)
    ...
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.EntityFactory.special_fields)
...
pub mod entity_factory {
    ...
    #[non_exhaustive]
    // @@protoc_insertion_point(oneof:ignition.msgs.EntityFactory.from)
    pub enum From {
        // @@protoc_insertion_point(oneof_field:ignition.msgs.EntityFactory.sdf)
        Sdf(::std::string::String),
        // @@protoc_insertion_point(oneof_field:ignition.msgs.EntityFactory.sdf_filename)
        SdfFilename(::std::string::String),
        // @@protoc_insertion_point(oneof_field:ignition.msgs.EntityFactory.model)
        Model(super::super::model::Model),
        // @@protoc_insertion_point(oneof_field:ignition.msgs.EntityFactory.light)
        Light(super::super::light::Light),
        // @@protoc_insertion_point(oneof_field:ignition.msgs.EntityFactory.clone_name)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"ignition/msgs/entity_factory.proto\x12\rignition.msgs\x1a\x1aignitio\
    n/msgs/header.proto\x1a\x19ignition/msgs/light.proto\x1a\x19ignition/msg\
    s/model.proto\x1a\x18ignition/msgs/pose.proto\x1a)ignition/msgs/spherica\
    l_coordinates.proto\"\xdb\x03\n\rEntityFactory\x12-\n\x06header\x18\x01\
    \x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x12\n\x03sdf\x18\
    \x02\x20\x01(\tH\0R\x03sdf\x12#\n\x0csdf_filename\x18\x03\x20\x01(\tH\0R\
    \x0bsdfFilename\x12,\n\x05model\x18\x04\x20\x01(\x0b2\x14.ignition.msgs.\
    ModelH\0R\x05model\x12,\n\x05light\x18\x05\x20\x01(\x0b2\x14.ignition.ms\
    gs.LightH\0R\x05light\x12\x1f\n\nclone_name\x18\x06\x20\x01(\tH\0R\tclon\
    eName\x12'\n\x04pose\x18\x07\x20\x01(\x0b2\x13.ignition.msgs.PoseR\x04po\
    se\x12\x12\n\x04name\x18\x08\x20\x01(\tR\x04name\x12%\n\x0eallow_renamin\
    g\x18\t\x20\x01(\x08R\rallowRenaming\x12\x1f\n\x0brelative_to\x18\n\x20\
    \x01(\tR\nrelativeTo\x12X\n\x15spherical_coordinates\x18\x0b\x20\x01(\
    \x0b2#.ignition.msgs.SphericalCoordinatesR\x14sphericalCoordinatesB\x06\
    \n\x04fromB(\n\x11com.ignition.msgsB\x13EntityFactoryProtosb\x06proto3\
";
