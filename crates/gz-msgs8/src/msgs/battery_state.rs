...
//! Generated file from `ignition/msgs/battery_state.proto`
...
// @@protoc_insertion_point(message:ignition.msgs.BatteryState)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct BatteryState {
    // message fields
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.header)
    pub header: ::protobuf::MessageField<super::header::Header>,
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.voltage)
    pub voltage: f64,
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.current)
    pub current: f64,
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.charge)
    pub charge: f64,
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.capacity)
    pub capacity: f64,
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.percentage)
    pub percentage: f64,
    // @@protoc_insertion_point(field:ignition.msgs.BatteryState.power_supply_status)
    pub power_supply_status: ::protobuf::EnumOrUnknown<battery_state::PowerSupplyStatus>,
    // special fields
    // @@protoc_insertion_point(special_field:ignition.msgs.BatteryState.special_fields)
...
pub mod battery_state {
    ...
    // @@protoc_insertion_point(enum:ignition.msgs.BatteryState.PowerSupplyStatus)
    pub enum PowerSupplyStatus {
        // @@protoc_insertion_point(enum_value:ignition.msgs.BatteryState.PowerSupplyStatus.UNKNOWN)
        UNKNOWN = 0,
        // @@protoc_insertion_point(enum_value:ignition.msgs.BatteryState.PowerSupplyStatus.CHARGING)
        CHARGING = 1,
        // @@protoc_insertion_point(enum_value:ignition.msgs.BatteryState.PowerSupplyStatus.DISCHARGING)
        DISCHARGING = 2,
        // @@protoc_insertion_point(enum_value:ignition.msgs.BatteryState.PowerSupplyStatus.NOT_CHARGING)
        NOT_CHARGING = 3,
        // @@protoc_insertion_point(enum_value:ignition.msgs.BatteryState.PowerSupplyStatus.FULL)
        FULL = 4,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!ignition/msgs/battery_state.proto\x12\rignition.msgs\x1a\x1aignition/\
    msgs/header.proto\"\x81\x03\n\x0cBatteryState\x12-\n\x06header\x18\x01\
    \x20\x01(\x0b2\x15.ignition.msgs.HeaderR\x06header\x12\x18\n\x07voltage\
    \x18\x02\x20\x01(\x01R\x07voltage\x12\x18\n\x07current\x18\x03\x20\x01(\
    \x01R\x07current\x12\x16\n\x06charge\x18\x04\x20\x01(\x01R\x06charge\x12\
    \x1a\n\x08capacity\x18\x05\x20\x01(\x01R\x08capacity\x12\x1e\n\npercenta\
    ge\x18\x06\x20\x01(\x01R\npercentage\x12]\n\x13power_supply_status\x18\
    \x07\x20\x01(\x0e2-.ignition.msgs.BatteryState.PowerSupplyStatusR\x11pow\
    erSupplyStatus\"[\n\x11PowerSupplyStatus\x12\x0b\n\x07UNKNOWN\x10\0\x12\
    \x0c\n\x08CHARGING\x10\x01\x12\x0f\n\x0bDISCHARGING\x10\x02\x12\x10\n\
    \x0cNOT_CHARGING\x10\x03\x12\x08\n\x04FULL\x10\x04B'\n\x11com.ignition.m\
    sgsB\x12BatteryStateProtosb\x06proto3\
";
